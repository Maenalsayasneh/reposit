...
public class j extends c implements MenuItem {
    public final h0.i.d.a.b d;
    public Method e;

    /* compiled from: MenuItemWrapperICS */
    public class a extends h0.i.i.b {
    ...
    /* compiled from: MenuItemWrapperICS */
    public static class c extends FrameLayout implements h0.b.e.b {
    ...
    public j(Context context, h0.i.d.a.b bVar) {
        super(context);
        if (bVar != null) {
            this.d = bVar;
            return;
