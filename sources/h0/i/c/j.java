...
public class j extends l {
    public Typeface a(Context context, d dVar, Resources resources, int i) {
        try {
            ...
            while (true) {
                ...
                e eVar = eVarArr[i3];
                try {
                    Font.Builder weight = new Font.Builder(resources, eVar.f).setWeight(eVar.b);
                    if (!eVar.c) {
                        i4 = 0;
                    }
                    Font build = weight.setSlant(i4).setTtcIndex(eVar.e).setFontVariationSettings(eVar.d).build();
                    if (builder == null) {
            ...
            int i5 = (i & 1) != 0 ? 700 : RequestResponse.HttpStatusCode._4xx.BAD_REQUEST;
            if ((i & 2) != 0) {
                i2 = 1;
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0063, code lost:
        r12 = com.instabug.library.network.RequestResponse.HttpStatusCode._4xx.BAD_REQUEST;
     */
    ...
    public android.graphics.Typeface b(android.content.Context r11, android.os.CancellationSignal r12, h0.i.f.l[] r13, int r14) {
        /*
            r10 = this;
        ...
        L_0x007f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: h0.i.c.j.b(android.content.Context, android.os.CancellationSignal, h0.i.f.l[], int):android.graphics.Typeface");
    }
