...
public class i extends k {
    ...
    public int doFinal(byte[] bArr, int i) {
        if (this.d != 32) {
            ...
            f(bArr3, bArr4);
            bArr3[0] = k.e(bArr4[0], bArr2, 0);
            bArr3[1] = k.e(bArr4[1], bArr2, 16);
