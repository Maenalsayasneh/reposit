...
public class p0 implements e {
        ...
        if (this.i == null) {
            ...
            if (z) {
                ...
                while (i7 < this.h) {
                    ...
                    while (i8 < i5) {
                        long j7 = j4;
                        int i9 = (int) ((this.j >> i8) & j2);
                        int i10 = (int) ((this.k >> i8) & j2);
                        int i11 = (int) ((this.l >> i8) & j2);
                        int i12 = (int) ((this.m >> i8) & j2);
                        long g2 = j7 | (((long) ((((g(i9) ^ h(i10)) ^ i11) ^ i12) & 255)) << i8);
                        long g3 = j3 | (((long) ((((g(i10) ^ h(i11)) ^ i12) ^ i9) & 255)) << i8);
                        j6 |= ((long) ((((g(i11) ^ h(i12)) ^ i9) ^ i10) & 255)) << i8;
                        j5 |= ((long) ((((g(i12) ^ h(i9)) ^ i10) ^ i11) & 255)) << i8;
                        i8 += 8;
                        byte[] bArr4 = bArr2;
                        int i13 = i3;
                        j4 = g2;
                ...
                while (i15 > 0) {
                    ...
                    for (int i17 = 32; i16 < i17; i17 = 32) {
                        int i18 = (int) ((this.j >> i16) & 255);
                        long[][] jArr4 = jArr3;
                        int i19 = (int) ((this.k >> i16) & 255);
                        int i20 = i15;
                        int i21 = (int) ((this.l >> i16) & 255);
                        int i22 = (int) ((this.m >> i16) & 255);
                        byte b2 = i18 != 0 ? a[i18 & 255] & 255 : -1;
                        byte b3 = i19 != 0 ? a[i19 & 255] & 255 : -1;
                        byte b4 = i21 != 0 ? a[i21 & 255] & 255 : -1;
                        byte b5 = i22 != 0 ? a[i22 & 255] & 255 : -1;
                        j10 |= ((long) ((((l(b2) ^ j(b3)) ^ k(b4)) ^ i(b5)) & 255)) << i16;
                        j11 |= ((long) ((((l(b3) ^ j(b4)) ^ k(b5)) ^ i(b2)) & 255)) << i16;
                        j9 |= ((long) ((((l(b4) ^ j(b5)) ^ k(b2)) ^ i(b3)) & 255)) << i16;
                        j8 = (((long) ((((j(b2) ^ l(b5)) ^ k(b3)) ^ i(b4)) & 255)) << i16) | j8;
                        i16 += 8;
                        i15 = i20;
                        byte[] bArr6 = bArr2;
                        int i23 = i3;
    ...
    public final void d(byte[] bArr) {
        this.k = n(this.k, bArr[1]);
        this.l = n(this.l, bArr[2]);
        this.m = n(this.m, bArr[3]);
    }

    public final void e(byte[] bArr) {
        this.j = f(this.j, bArr);
        this.k = f(this.k, bArr);
        this.l = f(this.l, bArr);
        this.m = f(this.m, bArr);
    }

    public final long f(long j2, byte[] bArr) {
        long j3 = 0;
    ...
    public void init(boolean z, i iVar) {
        ...
        if (iVar2 instanceof y0) {
            byte[] bArr = ((y0) iVar2).c;
            int i2 = 8;
            int length = bArr.length * 8;
            byte[][] bArr2 = (byte[][]) Array.newInstance(byte.class, new int[]{4, 64});
            ...
            int i8 = 0;
            int i9 = 0;
            while (i8 < i2 && i9 < (this.h + 1) * 4) {
                for (int i10 = 0; i10 < 4; i10++) {
                    long[] jArr2 = jArr[i9 / 4];
                    jArr2[i10] = jArr2[i10] | (((long) (bArr2[i10][i8] & 255)) << ((i9 * 8) % 32));
                }
                i8++;
                i9++;
            }
            int i11 = 0;
            while (i9 < (this.h + 1) * i4) {
                int i12 = i5;
                while (i12 < i4) {
                    byte[] bArr3 = bArr2[i12];
                    i12++;
                    bArr3[i5] = (byte) (bArr3[i5] ^ c[bArr2[i12 % 4][i2 - 1] & 255]);
                }
                byte[] bArr4 = bArr2[i5];
                int i13 = i11 + 1;
                bArr4[i5] = (byte) (e[i11] ^ bArr4[i5]);
                int i14 = 1;
                if (i2 <= i3) {
                    while (i14 < i2) {
                    ...
                    for (int i17 = i5; i17 < i4; i17++) {
                        ...
                        bArr7[i4] = (byte) (bArr7[i4] ^ c[bArr2[i17][3] & 255]);
                    }
                ...
                int i20 = i5;
                while (i5 < i2 && i9 < (this.h + 1) * i4) {
                    while (i20 < i4) {
                        long[] jArr3 = jArr[i9 / 4];
                        jArr3[i20] = (((long) (bArr2[i20][i5] & 255)) << ((i9 * 8) % 32)) | jArr3[i20];
                        i20++;
                        i4 = 4;
                    }
                    i5++;
        ...
        throw new IllegalArgumentException(a.L0(iVar2, a.P0("invalid parameter passed to Rijndael init - ")));
    }
    ...
    public final void m(byte[] bArr, int i2) {
        for (int i3 = 0; i3 != 32; i3 += 8) {
            int i4 = i2 + 1;
            bArr[i2] = (byte) ((int) (this.j >> i3));
            int i5 = i4 + 1;
            bArr[i4] = (byte) ((int) (this.k >> i3));
            int i6 = i5 + 1;
            bArr[i5] = (byte) ((int) (this.l >> i3));
            i2 = i6 + 1;
            bArr[i6] = (byte) ((int) (this.m >> i3));
        }
    }

    public final long n(long j2, int i2) {
        return ((j2 << (32 - i2)) | (j2 >>> i2)) & 4294967295L;
    }

    public final void o(byte[] bArr, int i2) {
        int i3 = i2 + 1;
        this.j = (long) (bArr[i2] & 255);
        int i4 = i3 + 1;
        this.k = (long) (bArr[i3] & 255);
        int i5 = i4 + 1;
        this.l = (long) (bArr[i4] & 255);
        int i6 = i5 + 1;
        this.m = (long) (bArr[i5] & 255);
        for (int i7 = 8; i7 != 32; i7 += 8) {
            int i8 = i6 + 1;
            this.j |= ((long) (bArr[i6] & 255)) << i7;
            int i9 = i8 + 1;
            this.k |= ((long) (bArr[i8] & 255)) << i7;
            int i10 = i9 + 1;
            this.l |= ((long) (bArr[i9] & 255)) << i7;
            i6 = i10 + 1;
            this.m |= ((long) (bArr[i10] & 255)) << i7;
        }
    }
