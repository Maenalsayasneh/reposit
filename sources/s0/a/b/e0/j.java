...
public class j implements e {
    ...
    public static void i(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 0;
        int i7 = i3 + 1;
        int i8 = 32 - i2;
    ...
    public static void j(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    public int a(byte[] bArr, int i2, byte[] bArr2, int i3) throws DataLengthException, IllegalStateException {
        ...
        if (!this.f) {
            ...
            for (int i5 = 0; i5 < 4; i5++) {
                this.k[i5] = c(bArr3, (i5 * 4) + i2);
                int[] iArr = this.k;
                iArr[i5] = iArr[i5] ^ this.i[i5];
            }
            d(this.k, this.h, 0);
            d(this.k, this.h, 4);
            d(this.k, this.h, 8);
            ...
            h(iArr2[2], bArr4, i4);
            h(this.k[3], bArr4, i4 + 4);
            h(this.k[0], bArr4, i4 + 8);
            h(this.k[1], bArr4, i4 + 12);
            return 16;
        } else {
            for (int i7 = 0; i7 < 4; i7++) {
                this.k[i7] = c(bArr3, (i7 * 4) + i2);
                int[] iArr4 = this.k;
                iArr4[i7] = iArr4[i7] ^ this.i[i7];
            }
            d(this.k, this.h, 0);
            d(this.k, this.h, 4);
            d(this.k, this.h, 8);
    ...
    public final void d(int[] iArr, int[] iArr2, int i2) {
        ...
        iArr[0] = iArr[0] ^ i13;
        iArr[1] = (i13 ^ ((i11 >>> 8) + (i11 << 24))) ^ iArr[1];
    }

    public final void e(int[] iArr, int[] iArr2, int i2) {
        int i3 = iArr[1];
        int i4 = iArr[0] & iArr2[i2 + 0];
        iArr[1] = i3 ^ ((i4 << 1) + (i4 >>> 31));
        iArr[0] = (iArr[1] | iArr2[i2 + 1]) ^ iArr[0];
        iArr[2] = iArr[2] ^ (iArr2[i2 + 3] | iArr[3]);
        int i5 = iArr[3];
        int i6 = iArr2[i2 + 2] & iArr[2];
        iArr[3] = i5 ^ ((i6 << 1) + (i6 >>> 31));
    }
        ...
        if (iVar2 instanceof y0) {
            ...
            if (this.g) {
                ...
                if (z) {
                    ...
                    iArr5[2] = iArr[2];
                    iArr5[3] = iArr[3];
                    i(15, iArr, 0, this.h, 4);
                    i(30, iArr, 0, this.h, 12);
                    i(15, iArr, 0, iArr4, 0);
                    int[] iArr6 = this.h;
                    iArr6[18] = iArr4[2];
                    iArr6[19] = iArr4[3];
                    i(17, iArr, 0, this.j, 4);
                    i(17, iArr, 0, this.h, 24);
                    i(17, iArr, 0, this.h, 32);
                    int[] iArr7 = this.h;
                    iArr7[0] = iArr2[0];
                    iArr7[1] = iArr2[1];
                    iArr7[2] = iArr2[2];
                    iArr7[3] = iArr2[3];
                    i(15, iArr2, 0, iArr7, 8);
                    i(15, iArr2, 0, this.j, 0);
                    i(15, iArr2, 0, iArr4, 0);
                    int[] iArr8 = this.h;
                    iArr8[16] = iArr4[0];
                    iArr8[17] = iArr4[1];
                    i(15, iArr2, 0, iArr8, 20);
                    j(34, iArr2, 0, this.h, 28);
                    i(17, iArr2, 0, this.i, 4);
                } else {
                    iArr5[4] = iArr[0];
                    iArr5[5] = iArr[1];
                    iArr5[6] = iArr[2];
                    iArr5[7] = iArr[3];
                    f(15, iArr, 0, this.h, 28);
                    f(30, iArr, 0, this.h, 20);
                    f(15, iArr, 0, iArr4, 0);
                    int[] iArr9 = this.h;
                    iArr9[16] = iArr4[0];
                    iArr9[17] = iArr4[1];
                    f(17, iArr, 0, this.j, 0);
                    f(17, iArr, 0, this.h, 8);
                    f(17, iArr, 0, this.h, 0);
                    int[] iArr10 = this.h;
                    iArr10[34] = iArr2[0];
                    iArr10[35] = iArr2[1];
                    iArr10[32] = iArr2[2];
                    iArr10[33] = iArr2[3];
                    f(15, iArr2, 0, iArr10, 24);
                    f(15, iArr2, 0, this.j, 4);
                    f(15, iArr2, 0, iArr4, 0);
                    int[] iArr11 = this.h;
                    iArr11[18] = iArr4[2];
                    iArr11[19] = iArr4[3];
                    f(15, iArr2, 0, iArr11, 12);
                    g(34, iArr2, 0, this.h, 4);
                    i(17, iArr2, 0, this.i, 0);
                }
            } else {
                for (int i4 = 0; i4 < 4; i4++) {
                ...
                if (z) {
                    ...
                    iArr12[2] = iArr[2];
                    iArr12[3] = iArr[3];
                    j(45, iArr, 0, this.h, 16);
                    i(15, iArr, 0, this.j, 4);
                    i(17, iArr, 0, this.h, 32);
                    j(34, iArr, 0, this.h, 44);
                    i(15, iArr, 4, this.h, 4);
                    i(15, iArr, 4, this.j, 0);
                    i(30, iArr, 4, this.h, 24);
                    j(34, iArr, 4, this.h, 36);
                    i(15, iArr2, 0, this.h, 8);
                    i(30, iArr2, 0, this.h, 20);
                    int[] iArr13 = this.j;
                    iArr13[8] = iArr2[1];
                    iArr13[9] = iArr2[2];
                    iArr13[10] = iArr2[3];
                    iArr13[11] = iArr2[0];
                    j(49, iArr2, 0, this.h, 40);
                    int[] iArr14 = this.h;
                    iArr14[0] = iArr3[0];
                    iArr14[1] = iArr3[1];
                    iArr14[2] = iArr3[2];
                    iArr14[3] = iArr3[3];
                    i(30, iArr3, 0, iArr14, 12);
                    i(30, iArr3, 0, this.h, 28);
                    j(51, iArr3, 0, this.i, 4);
                } else {
                    iArr12[4] = iArr[0];
                    iArr12[5] = iArr[1];
                    iArr12[6] = iArr[2];
                    iArr12[7] = iArr[3];
                    g(45, iArr, 0, this.h, 28);
                    f(15, iArr, 0, this.j, 4);
                    f(17, iArr, 0, this.h, 12);
                    g(34, iArr, 0, this.h, 0);
                    f(15, iArr, 4, this.h, 40);
                    f(15, iArr, 4, this.j, 8);
                    f(30, iArr, 4, this.h, 20);
                    g(34, iArr, 4, this.h, 8);
                    f(15, iArr2, 0, this.h, 36);
                    f(30, iArr2, 0, this.h, 24);
                    int[] iArr15 = this.j;
                    iArr15[2] = iArr2[1];
                    iArr15[3] = iArr2[2];
                    iArr15[0] = iArr2[3];
                    iArr15[1] = iArr2[0];
                    g(49, iArr2, 0, this.h, 4);
                    int[] iArr16 = this.h;
                    iArr16[46] = iArr3[0];
                    iArr16[47] = iArr3[1];
                    iArr16[44] = iArr3[2];
                    iArr16[45] = iArr3[3];
                    f(30, iArr3, 0, iArr16, 32);
                    f(30, iArr3, 0, this.h, 16);
                    j(51, iArr3, 0, this.i, 0);
                }
            }
            this.f = true;
            return;
