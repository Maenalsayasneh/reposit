...
public class u1 extends h.b {
    public u1(e eVar, g gVar, g gVar2) {
        super(eVar, gVar, gVar2);
    }

    public u1(e eVar, g gVar, g gVar2, g[] gVarArr) {
    ...
    public h A(h hVar) {
        ...
        if (l.i()) {
            return new u1(eVar, l, eVar.c.n());
        }
        g j2 = l.o().j(j);
        g j3 = l.j(o4).j(o3);
        return new u1(eVar, j2, l.a(o4).o().l(a, b, j3), new g[]{j3});
    }
    ...
    public h a(h hVar) {
        ...
        if (gVar8.i()) {
            ...
            if (gVar5.i()) {
                return new u1(eVar, gVar5, eVar.c.n());
            }
            ...
            g j4 = j2.j(j3);
            if (j4.i()) {
                return new u1(eVar, j4, eVar.c.n());
            }
            g j5 = a.j(o);
            if (!h2) {
                j5 = j5.j(k);
        ...
        return new u1(eVar, gVar5, gVar4, new g[]{gVar6});
    }

    public h b() {
        return new u1((e) null, d(), e());
    }
    ...
    public h p() {
        ...
        g gVar2 = this.d;
        g gVar3 = this.e[0];
        return new u1(this.b, gVar, gVar2.a(gVar3), new g[]{gVar3});
    }
    ...
    public h z() {
        ...
        if (s1.i()) {
            return new u1(eVar, s1, eVar.c.n());
        }
        g o2 = s1.o();
        g j2 = h ? s1 : s1.j(o);
        if (!h) {
        ...
        return new u1(eVar, o2, gVar.p(s1, j).a(o2).a(j2), new g[]{j2});
    }
}
