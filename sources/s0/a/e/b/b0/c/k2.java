...
public class k2 extends h.b {
    public k2(e eVar, g gVar, g gVar2) {
        super(eVar, gVar, gVar2);
    }

    public k2(e eVar, g gVar, g gVar2, g[] gVarArr) {
    ...
    public h A(h hVar) {
        ...
        if (l.i()) {
            return new k2(eVar, l, eVar.c.n());
        }
        g j2 = l.o().j(j);
        g j3 = l.j(o4).j(o3);
        return new k2(eVar, j2, l.a(o4).o().l(a, b, j3), new g[]{j3});
    }
    ...
    public h a(h hVar) {
        ...
        if (gVar8.i()) {
            ...
            if (gVar5.i()) {
                return new k2(eVar, gVar5, eVar.c.n());
            }
            ...
            g j4 = j2.j(j3);
            if (j4.i()) {
                return new k2(eVar, j4, eVar.c.n());
            }
            g j5 = a.j(o);
            if (!h2) {
                j5 = j5.j(k);
        ...
        return new k2(eVar, gVar5, gVar4, new g[]{gVar6});
    }

    public h b() {
        return new k2((e) null, d(), e());
    }
    ...
    public h p() {
        ...
        g gVar2 = this.d;
        g gVar3 = this.e[0];
        return new k2(this.b, gVar, gVar2.a(gVar3), new g[]{gVar3});
    }
    ...
    public h z() {
        ...
        if (s1.i()) {
            return new k2(eVar, s1, eVar.c.n());
        }
        g o2 = s1.o();
        g j2 = h ? s1 : s1.j(o);
        if (!h) {
        ...
        return new k2(eVar, o2, gVar.p(s1, j).a(o2).a(j2), new g[]{j2});
    }
}
