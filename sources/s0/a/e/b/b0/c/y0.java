...
public class y0 {
    ...
    public static void a(int[] iArr, int[] iArr2, int[] iArr3) {
        if (h3.c(12, iArr, iArr2, iArr3) != 0 || (iArr3[11] == -1 && h3.f1(12, iArr3, a))) {
            b(iArr3);
        }
    }
    ...
    public static void f(int i, int[] iArr) {
        ...
        if ((j != 0 && h3.z1(12, iArr, 5) != 0) || (iArr[11] == -1 && h3.f1(12, iArr, a))) {
            b(iArr);
        }
    }
    ...
    public static void i(int[] iArr, int[] iArr2, int[] iArr3) {
        if (h3.W2(12, iArr, iArr2, iArr3) != 0) {
