...
public final class SessionAdapter extends TypeAdapter<Session> {
    ...
    private boolean initAttrs(JsonWriter jsonWriter, boolean z) throws IOException {
        ...
        jsonWriter.name(UserAttributesCacheManager.USER_ATTRIBUTES_CACHE_KEY).beginObject();
        return true;
    }
    ...
    public io.sentry.Session read(com.google.gson.stream.JsonReader r23) throws java.io.IOException {
        ...
        L_0x015b:
            ...
            goto L_0x0192
        L_0x015e:
            java.lang.String r1 = r23.nextString()     // Catch:{ IllegalArgumentException -> 0x016b }
            java.lang.String r1 = io.sentry.util.StringUtils.capitalize(r1)     // Catch:{ IllegalArgumentException -> 0x016b }
            io.sentry.Session$State r5 = io.sentry.Session.State.valueOf(r1)     // Catch:{ IllegalArgumentException -> 0x016c }
            goto L_0x015b
        L_0x016b:
            r1 = 0
        L_0x016c:
    ...
    public void write(JsonWriter jsonWriter, Session session) throws IOException {
        ...
        if (started != null) {
            jsonWriter.name(SDKCoreEvent.Session.VALUE_STARTED).value(DateUtils.getTimestamp(started));
        }
