...
public final class OutboxSender extends DirectoryProcessor implements IEnvelopeSender {
    ...
    public void processFile(java.io.File r11, java.lang.Object r12) {
        ...
        L_0x009d:
            ...
            boolean r12 = r12.isRetry()
            if (r12 != 0) goto L_0x00dd
            boolean r12 = r11.delete()     // Catch:{ RuntimeException -> 0x00c7 }
            if (r12 != 0) goto L_0x00dd
            io.sentry.ILogger r12 = r10.logger     // Catch:{ RuntimeException -> 0x00c7 }
            java.lang.Object[] r1 = new java.lang.Object[r3]     // Catch:{ RuntimeException -> 0x00c7 }
            java.lang.String r4 = r11.getAbsolutePath()     // Catch:{ RuntimeException -> 0x00c7 }
            r1[r2] = r4     // Catch:{ RuntimeException -> 0x00c7 }
            r12.log((io.sentry.SentryLevel) r5, (java.lang.String) r0, (java.lang.Object[]) r1)     // Catch:{ RuntimeException -> 0x00c7 }
            goto L_0x00dd
        L_0x00c7:
            r12 = move-exception
            io.sentry.ILogger r1 = r10.logger
        ...
        L_0x00de:
            ...
            boolean r12 = r11.delete()     // Catch:{ RuntimeException -> 0x0100 }
            if (r12 != 0) goto L_0x0116
            io.sentry.ILogger r12 = r10.logger     // Catch:{ RuntimeException -> 0x0100 }
            io.sentry.SentryLevel r4 = io.sentry.SentryLevel.ERROR     // Catch:{ RuntimeException -> 0x0100 }
            java.lang.Object[] r5 = new java.lang.Object[r3]     // Catch:{ RuntimeException -> 0x0100 }
            java.lang.String r6 = r11.getAbsolutePath()     // Catch:{ RuntimeException -> 0x0100 }
            r5[r2] = r6     // Catch:{ RuntimeException -> 0x0100 }
            r12.log((io.sentry.SentryLevel) r4, (java.lang.String) r0, (java.lang.Object[]) r5)     // Catch:{ RuntimeException -> 0x0100 }
            goto L_0x0116
        L_0x0100:
            r12 = move-exception
