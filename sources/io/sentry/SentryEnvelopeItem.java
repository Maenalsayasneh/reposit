...
public final class SentryEnvelopeItem {
    ...
    public static SentryEnvelopeItem fromAttachment(Attachment attachment, long j) {
        CachedItem cachedItem = new CachedItem(new l(attachment, j));
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.Attachment, (Callable<Integer>) new j(cachedItem), attachment.getContentType(), attachment.getFilename()), (Callable<byte[]>) new m(cachedItem));
    }
    ...
    public static SentryEnvelopeItem fromEvent(ISerializer iSerializer, SentryBaseEvent sentryBaseEvent) throws IOException {
        ...
        CachedItem cachedItem = new CachedItem(new k(iSerializer, sentryBaseEvent));
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.resolve(sentryBaseEvent), (Callable<Integer>) new r(cachedItem), NetworkLog.JSON, (String) null), (Callable<byte[]>) new p(cachedItem));
    }

    public static SentryEnvelopeItem fromSession(ISerializer iSerializer, Session session) throws IOException {
        Objects.requireNonNull(iSerializer, "ISerializer is required.");
        Objects.requireNonNull(session, "Session is required.");
        CachedItem cachedItem = new CachedItem(new t(iSerializer, session));
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.Session, (Callable<Integer>) new s(cachedItem), NetworkLog.JSON, (String) null), (Callable<byte[]>) new q(cachedItem));
    }
    ...
    public static SentryEnvelopeItem fromUserFeedback(ISerializer iSerializer, UserFeedback userFeedback) {
        ...
        CachedItem cachedItem = new CachedItem(new n(iSerializer, userFeedback));
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.UserFeedback, (Callable<Integer>) new u(cachedItem), NetworkLog.JSON, (String) null), (Callable<byte[]>) new o(cachedItem));
    }
