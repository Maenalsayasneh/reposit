...
public class ViEAndroidGLES20 extends GLSurfaceView implements GLSurfaceView.Renderer, GLRendererController {
    ...
    public void UpdateOpenGLResource(int[] iArr) {
        ...
        String str = TAG;
        StringBuilder P0 = a.P0("UpdateOpenGLResource, program = ");
        P0.append(iArr[0]);
        P0.append(" texture[0~2] = ");
        P0.append(iArr[1]);
        P0.append(" ,");
        P0.append(iArr[2]);
        P0.append(" ,");
        P0.append(iArr[3]);
        Logging.i(str, P0.toString());
    }
        ...
        if (this.nativeGLResourceUpdated) {
            queueEvent(new Runnable() {
                public void run() {
                    ...
                    StringBuilder P0 = a.P0("releaseOpenGLResource, value = ");
                    P0.append(ViEAndroidGLES20.this.nativeGLPragram);
                    P0.append(" ,");
                    P0.append(ViEAndroidGLES20.this.nativeGLTextureId[0]);
                    P0.append(" ,");
                    P0.append(ViEAndroidGLES20.this.nativeGLTextureId[1]);
                    P0.append(" ,");
                    P0.append(ViEAndroidGLES20.this.nativeGLTextureId[2]);
                    P0.append(", ");
                    P0.append(ViEAndroidGLES20.this.nativeOesGLPragram);
                    Logging.i(access$000, P0.toString());
