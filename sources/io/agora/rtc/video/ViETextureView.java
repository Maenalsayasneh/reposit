        ...
        if (this.nativeGLResourceUpdated) {
            queueEvent(new Runnable() {
                public void run() {
                    ...
                    P0.append(ViETextureView.this.nativeGLPragram);
                    P0.append(" ,");
                    P0.append(ViETextureView.this.nativeGLTextureId[0]);
                    P0.append(" ,");
                    P0.append(ViETextureView.this.nativeGLTextureId[1]);
                    P0.append(" ,");
                    P0.append(ViETextureView.this.nativeGLTextureId[2]);
                    P0.append(", ");
                    P0.append(ViETextureView.this.nativeOesGLProgram);
