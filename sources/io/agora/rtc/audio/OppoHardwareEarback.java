            ...
            if (context != null && this.isConnected) {
                ...
                if (z) {
                    if (safeCallMethod != null) {
                        Object newProxyInstance = Proxy.newProxyInstance(this.clsOnConnectionSucceedListener.getClassLoader(), new Class[]{this.clsOnConnectionSucceedListener}, new InvocationHandler() {
                    ...
                    Object newProxyInstance2 = Proxy.newProxyInstance(this.clsOnConnectionSucceedListener.getClassLoader(), new Class[]{this.clsOnConnectionSucceedListener}, new InvocationHandler() {
                        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
                            if (!method.getName().equals("onConnectionSucceed") || OppoHardwareEarback.this.mContext == null) {
                                return null;
                            }
