...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    public VideoFrame.TextureBuffer toAGraphicBufferEx() {
        ...
        StringBuilder P0 = a.P0("mini api level 26 is needed, curr: ");
    ...
    public String toString() {
        StringBuilder P0 = a.P0("TextureBufferImpl{eglContext=");
        ...
        P0.append(this.type);
        P0.append(", seq=");
        P0.append(this.sequence);
        P0.append(", id=");
        P0.append(this.id);
        P0.append(", refCount=");
        return a.s0(P0, this.refCount, '}');
    }
