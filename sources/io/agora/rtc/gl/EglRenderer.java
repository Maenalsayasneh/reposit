...
public class EglRenderer {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0027, code lost:
        if (r1 != androidx.recyclerview.widget.RecyclerView.FOREVER_NS) goto L_0x002a;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:?, code lost:
        r13.framesRendered++;
        r13.renderTimeNs = (r2 - r11) + r13.renderTimeNs;
        r13.renderSwapBufferTimeNs = (r2 - r0) + r13.renderSwapBufferTimeNs;
     */
    ...
    public void renderFrameOnRenderThread() {
        ...
        L_0x008d:
            ...
            long r7 = r2 - r11
            long r7 = r7 + r5
            r13.renderTimeNs = r7     // Catch:{ all -> 0x00df }
            long r5 = r13.renderSwapBufferTimeNs     // Catch:{ all -> 0x00df }
            long r2 = r2 - r0
            long r2 = r2 + r5
            r13.renderSwapBufferTimeNs = r2     // Catch:{ all -> 0x00df }
    ...
    public void release() {
        /*
            ...
            return
        L_0x0019:
            io.agora.rtc.gl.EglRenderer$3 r3 = new io.agora.rtc.gl.EglRenderer$3     // Catch:{ all -> 0x004e }
            ...
            io.agora.rtc.gl.EglRenderer$4 r4 = new io.agora.rtc.gl.EglRenderer$4     // Catch:{ all -> 0x004e }
            r4.<init>(r2, r0)     // Catch:{ all -> 0x004e }
            r3.post(r4)     // Catch:{ all -> 0x004e }
            io.agora.rtc.utils.ThreadUtils.awaitUninterruptibly(r0)     // Catch:{ all -> 0x004e }
            r0 = 0
            r5.renderThreadHandler = r0     // Catch:{ all -> 0x004e }
            monitor-exit(r1)     // Catch:{ all -> 0x004e }
            java.lang.Object r2 = r5.frameLock
            monitor-enter(r2)
            io.agora.rtc.gl.VideoFrame r1 = r5.pendingFrame     // Catch:{ all -> 0x004b }
            if (r1 == 0) goto L_0x0044
            r1.release()     // Catch:{ all -> 0x004b }
            r5.pendingFrame = r0     // Catch:{ all -> 0x004b }
        L_0x0044:
