...
public final class DeserializedMemberScope$NoReorderImplementation$variableNames$2 extends Lambda implements a<Set<? extends d>> {
    ...
    public Object invoke() {
        ...
        for (l lVar : list) {
            linkedHashSet.add(h.v1(deserializedMemberScope.c.b, ((ProtoBuf$Property) lVar).a2));
        }
        return g.d0(linkedHashSet, this.d.p());
    }
}
