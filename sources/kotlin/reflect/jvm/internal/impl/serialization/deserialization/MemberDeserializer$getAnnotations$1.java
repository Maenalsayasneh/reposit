...
public final class MemberDeserializer$getAnnotations$1 extends Lambda implements a<List<? extends c>> {
    ...
    public MemberDeserializer$getAnnotations$1(MemberDeserializer memberDeserializer, l lVar, AnnotatedCallableKind annotatedCallableKind) {
        super(0);
    ...
    public Object invoke() {
        ...
        if (a == null) {
            ...
            list = g.v0(this.c.a.a.e.j(a, this.d, this.q));
        }
