...
public class RemoveAllPushChannelsForDevice extends Endpoint<List<Object>, PNPushRemoveAllChannelsResult> {
    ...
    public RemoveAllPushChannelsForDevice(PubNub pubNub, TelemetryManager telemetryManager, RetrofitManager retrofitManager, TokenManager tokenManager) {
    ...
    public d<List<Object>> doWork(Map<String, String> map) throws PubNubException {
        ...
        if (pNPushType != PNPushType.APNS2) {
            ...
            return getRetrofit().getPushService().removeAllChannelsForDevice(getPubnub().getConfiguration().getSubscribeKey(), this.deviceId, map);
        }
        map.put("environment", this.environment.name().toLowerCase());
        map.put("topic", this.topic);
        return getRetrofit().getPushService().removeAllChannelsForDeviceApns2(getPubnub().getConfiguration().getSubscribeKey(), this.deviceId, map);
    }

    public RemoveAllPushChannelsForDevice environment(PNPushEnvironment pNPushEnvironment) {
    ...
    public RemoveAllPushChannelsForDevice topic(String str) {
        this.topic = str;
        return this;
    }
    ...
    public PNPushRemoveAllChannelsResult createResponse(v<List<Object>> vVar) throws PubNubException {
        if (vVar.b != null) {
