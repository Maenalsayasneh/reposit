...
public final class DefaultFlowController$paymentConfiguration$2 extends Lambda implements a<PaymentConfiguration> {
    ...
    public final PaymentConfiguration invoke() {
        return PaymentConfiguration.Companion.getInstance(this.this$0.appContext);
    }
}
