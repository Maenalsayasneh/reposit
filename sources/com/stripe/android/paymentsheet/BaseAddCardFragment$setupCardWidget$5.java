...
public final class BaseAddCardFragment$setupCardWidget$5 implements StripeEditText.ErrorMessageListener {
    public final /* synthetic */ BaseAddCardFragment this$0;

    public BaseAddCardFragment$setupCardWidget$5(BaseAddCardFragment baseAddCardFragment) {
        this.this$0 = baseAddCardFragment;
    }

    public final void displayErrorMessage(String str) {
        this.this$0.onCardError(BaseAddCardFragment.AddCardViewModel.Field.Date, str);
    }
}
