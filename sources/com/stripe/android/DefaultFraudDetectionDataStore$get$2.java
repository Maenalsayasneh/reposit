...
public final class DefaultFraudDetectionDataStore$get$2 extends SuspendLambda implements p<f0, m0.l.c<? super FraudDetectionData>, Object> {
    private /* synthetic */ Object L$0;
    public int label;
    public final /* synthetic */ DefaultFraudDetectionDataStore this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DefaultFraudDetectionDataStore$get$2(DefaultFraudDetectionDataStore defaultFraudDetectionDataStore, m0.l.c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((DefaultFraudDetectionDataStore$get$2) create(obj, (m0.l.c) obj2)).invokeSuspend(i.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            try {
                ...
                String string = access$getPrefs$p.getString("key_fraud_detection_data", (String) null);
                if (string == null) {
                    string = "";
                }
                JSONObject jSONObject = new JSONObject(string);
                obj2 = new FraudDetectionDataJsonParser(new DefaultFraudDetectionDataStore$get$2$1$timestampSupplier$1(jSONObject)).parse(jSONObject);
            } catch (Throwable th) {
                obj2 = h.l0(th);
            }
