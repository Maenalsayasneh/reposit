...
public final class CardMultilineWidget$initFocusChangeListeners$4 implements View.OnFocusChangeListener {
    public final /* synthetic */ CardMultilineWidget this$0;

    public CardMultilineWidget$initFocusChangeListeners$4(CardMultilineWidget cardMultilineWidget) {
        this.this$0 = cardMultilineWidget;
    }

    public final void onFocusChange(View view, boolean z) {
        CardInputListener access$getCardInputListener$p;
        if (this.this$0.shouldShowPostalCode && z && (access$getCardInputListener$p = this.this$0.cardInputListener) != null) {
