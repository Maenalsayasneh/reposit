...
public final class CardMultilineWidget$initFocusChangeListeners$2 implements View.OnFocusChangeListener {
    public final /* synthetic */ CardMultilineWidget this$0;

    public CardMultilineWidget$initFocusChangeListeners$2(CardMultilineWidget cardMultilineWidget) {
    ...
    public final void onFocusChange(View view, boolean z) {
        ...
        if (z && (access$getCardInputListener$p = this.this$0.cardInputListener) != null) {
            access$getCardInputListener$p.onFocusChange(CardInputListener.FocusField.ExpiryDate);
        }
    }
}
