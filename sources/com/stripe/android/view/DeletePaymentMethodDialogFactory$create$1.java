...
public final class DeletePaymentMethodDialogFactory$create$1 implements DialogInterface.OnClickListener {
    public final /* synthetic */ PaymentMethod $paymentMethod;
    public final /* synthetic */ DeletePaymentMethodDialogFactory this$0;

    public DeletePaymentMethodDialogFactory$create$1(DeletePaymentMethodDialogFactory deletePaymentMethodDialogFactory, PaymentMethod paymentMethod) {
        this.this$0 = deletePaymentMethodDialogFactory;
        this.$paymentMethod = paymentMethod;
    }

    public final void onClick(DialogInterface dialogInterface, int i) {
        this.this$0.onDeletedPaymentMethod$payments_core_release(this.$paymentMethod);
    }
}
