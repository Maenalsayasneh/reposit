...
public final class CardInputWidget$initView$8 implements View.OnFocusChangeListener {
    public final /* synthetic */ CardInputWidget this$0;

    public CardInputWidget$initView$8(CardInputWidget cardInputWidget) {
        this.this$0 = cardInputWidget;
    }

    public final void onFocusChange(View view, boolean z) {
        this.this$0.getCardBrandView$payments_core_release().setShouldShowCvc(z);
        if (z) {
