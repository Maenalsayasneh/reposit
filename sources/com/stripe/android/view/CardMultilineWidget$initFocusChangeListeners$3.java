...
public final class CardMultilineWidget$initFocusChangeListeners$3 implements View.OnFocusChangeListener {
    public final /* synthetic */ CardMultilineWidget this$0;

    public CardMultilineWidget$initFocusChangeListeners$3(CardMultilineWidget cardMultilineWidget) {
        this.this$0 = cardMultilineWidget;
    }

    public final void onFocusChange(View view, boolean z) {
        if (z) {
            if (!this.this$0.showCvcIconInCvcField) {
            ...
            if (access$getCardInputListener$p != null) {
                access$getCardInputListener$p.onFocusChange(CardInputListener.FocusField.Cvc);
                return;
            }
            return;
        }
