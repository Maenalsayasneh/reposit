...
public final class CardInputWidget$initView$5 implements View.OnFocusChangeListener {
    public final /* synthetic */ CardInputWidget this$0;

    public CardInputWidget$initView$5(CardInputWidget cardInputWidget) {
        this.this$0 = cardInputWidget;
    }

    public final void onFocusChange(View view, boolean z) {
        if (z) {
            this.this$0.scrollStart();
