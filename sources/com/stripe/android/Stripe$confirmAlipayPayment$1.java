...
@c(c = "com.stripe.android.Stripe$confirmAlipayPayment$1", f = "Stripe.kt", l = {259}, m = "invokeSuspend")
...
public final class Stripe$confirmAlipayPayment$1 extends SuspendLambda implements l<m0.l.c<? super PaymentIntentResult>, Object> {
    ...
    public Stripe$confirmAlipayPayment$1(Stripe stripe, ConfirmPaymentIntentParams confirmPaymentIntentParams, AlipayAuthenticator alipayAuthenticator, String str, m0.l.c cVar) {
        super(1, cVar);
        this.this$0 = stripe;
    ...
    public final m0.l.c<i> create(m0.l.c<?> cVar) {
        ...
        return new Stripe$confirmAlipayPayment$1(this.this$0, this.$confirmPaymentIntentParams, this.$authenticator, this.$stripeAccountId, cVar);
    }

    public final Object invoke(Object obj) {
        return ((Stripe$confirmAlipayPayment$1) create((m0.l.c) obj)).invokeSuspend(i.a);
    }
