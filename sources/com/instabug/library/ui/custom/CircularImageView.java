...
public class CircularImageView extends AppCompatImageView {
    ...
    private void setup() {
        if (!this.mReady) {
            ...
            if (!this.mBorderOverlay) {
                ...
                float f = (float) this.mBorderWidth;
                rectF.inset(f, f);
            }
    ...
    private void updateShaderMatrix() {
        ...
        RectF rectF = this.mDrawableRect;
        matrix.postTranslate(((float) ((int) (f + 0.5f))) + rectF.left, ((float) ((int) (f3 + 0.5f))) + rectF.top);
    ...
    public CircularImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderColor = obtainStyledAttributes.getColor(R.styleable.CircleImageView_ibg_civ_border_color, DEFAULT_BORDER_COLOR);
