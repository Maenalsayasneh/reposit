...
public class PlaceHolderUtils {
    ...
    public static String getPlaceHolder(Context context, InstabugCustomTextPlaceHolder.Key key, int i) {
        String str;
        ...
        return LocaleUtils.getLocaleStringResource(Instabug.getLocale(context), i, context);
    }
}
