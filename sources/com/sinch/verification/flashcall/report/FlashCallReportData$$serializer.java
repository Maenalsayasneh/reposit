...
public final class FlashCallReportData$$serializer implements v<FlashCallReportData> {
    ...
    public void serialize(Encoder encoder, FlashCallReportData flashCallReportData) {
        i.e(encoder, "encoder");
        i.e(flashCallReportData, InstabugDbContract.UserAttributesEntry.COLUMN_VALUE);
        SerialDescriptor serialDescriptor = $$serialDesc;
        d c = encoder.c(serialDescriptor);
        i.e(flashCallReportData, "self");
        i.e(c, "output");
        i.e(serialDescriptor, "serialDesc");
        c.z(serialDescriptor, 0, FlashCallReportDetails$$serializer.INSTANCE, flashCallReportData.b);
        if ((!i.a(flashCallReportData.a, VerificationMethodType.FLASHCALL)) || c.v(serialDescriptor, 1)) {
            c.z(serialDescriptor, 1, VerificationMethodType.Companion, flashCallReportData.a);
        }
        c.b(serialDescriptor);
    }
