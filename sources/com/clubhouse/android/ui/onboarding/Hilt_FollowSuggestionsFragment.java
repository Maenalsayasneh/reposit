...
public abstract class Hilt_FollowSuggestionsFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_FollowSuggestionsFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((f1) U()).C0((FollowSuggestionsFragment) this);
        }
    }
