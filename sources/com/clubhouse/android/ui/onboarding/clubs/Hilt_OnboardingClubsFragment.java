...
import h0.q.m0;
import i0.e.b.g3.r.z2.g;
import i0.j.f.p.h;
import j0.a.a.c.c.f;
import j0.a.b.b;

public abstract class Hilt_OnboardingClubsFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_OnboardingClubsFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((g) U()).V((OnboardingClubsFragment) this);
        }
    }
