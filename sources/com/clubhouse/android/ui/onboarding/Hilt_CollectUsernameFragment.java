...
public abstract class Hilt_CollectUsernameFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_CollectUsernameFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((v0) U()).o((CollectUsernameFragment) this);
        }
    }
