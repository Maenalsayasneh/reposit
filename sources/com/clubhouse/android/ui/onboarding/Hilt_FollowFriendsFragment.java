...
public abstract class Hilt_FollowFriendsFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_FollowFriendsFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((d1) U()).B((FollowFriendsFragment) this);
        }
    }
