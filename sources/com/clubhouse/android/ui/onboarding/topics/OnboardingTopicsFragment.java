...
public final class OnboardingTopicsFragment extends Hilt_OnboardingTopicsFragment {
    ...
    public static final class a extends h<OnboardingTopicsFragment, OnboardingTopicsViewModel> {
        ...
        public c a(Object obj, k kVar) {
            ...
            i.e(kVar, "property");
            return g.a.b(fragment, kVar, this.a, new OnboardingTopicsFragment$special$$inlined$fragmentViewModel$default$2$1(this), m.a(f.class), false, this.b);
        }
    }

    public OnboardingTopicsFragment() {
        super(R.layout.fragment_onboarding_suggestions);
        d a3 = m.a(OnboardingTopicsViewModel.class);
        this.a2 = new a(a3, false, new OnboardingTopicsFragment$special$$inlined$fragmentViewModel$default$1(this, a3, a3), a3).a(this, Z1[0]);
    }

    public void J() {
        v.v2(O0(), new OnboardingTopicsFragment$invalidate$1(this));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        i0.e.b.d3.k.D(epoxyRecyclerView, this, new OnboardingTopicsFragment$buildModels$1(this));
        ...
        N0().b.setOnClickListener(new i0.e.b.g3.r.a3.c(this));
        N0().d.setOnClickListener(new b(this));
        N0().e.setOnClickListener(new i0.e.b.g3.r.a3.a(this));
        FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(O0().l, new OnboardingTopicsFragment$onViewCreated$4(this, (m0.l.c<? super OnboardingTopicsFragment$onViewCreated$4>) null));
