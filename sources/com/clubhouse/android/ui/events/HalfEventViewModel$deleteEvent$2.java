...
public final class HalfEventViewModel$deleteEvent$2 extends Lambda implements p<l0, b<? extends EmptySuccessResponse>, l0> {
    public final /* synthetic */ HalfEventViewModel c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HalfEventViewModel$deleteEvent$2(HalfEventViewModel halfEventViewModel) {
        super(2);
