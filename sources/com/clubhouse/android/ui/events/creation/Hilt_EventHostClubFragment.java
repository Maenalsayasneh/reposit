...
public abstract class Hilt_EventHostClubFragment extends BaseExpandedBottomSheetFragment implements b {
    public ContextWrapper l2;
    public volatile f m2;
    public final Object n2 = new Object();
    public boolean o2 = false;

    public Hilt_EventHostClubFragment(int i) {
        super(i);
    }
    ...
    public void T0() {
        if (!this.o2) {
            this.o2 = true;
            ((a0) U()).f((EventHostClubFragment) this);
        }
    }
