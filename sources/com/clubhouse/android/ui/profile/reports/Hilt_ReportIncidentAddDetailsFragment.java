...
public abstract class Hilt_ReportIncidentAddDetailsFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_ReportIncidentAddDetailsFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((j0) U()).t0((ReportIncidentAddDetailsFragment) this);
        }
    }
