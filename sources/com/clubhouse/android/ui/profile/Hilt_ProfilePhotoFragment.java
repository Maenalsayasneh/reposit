...
public abstract class Hilt_ProfilePhotoFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_ProfilePhotoFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((a5) U()).Q((ProfilePhotoFragment) this);
        }
    }
