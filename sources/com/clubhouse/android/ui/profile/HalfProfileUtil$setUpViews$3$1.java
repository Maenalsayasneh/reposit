...
public final class HalfProfileUtil$setUpViews$3$1 extends Lambda implements l<q4, i> {
    public final /* synthetic */ HalfProfileFragment c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HalfProfileUtil$setUpViews$3$1(HalfProfileFragment halfProfileFragment) {
        super(1);
