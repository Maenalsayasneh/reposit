...
import com.clubhouse.android.data.repos.UserRepo$getFollowersFromNotification$1;
...
public final class FollowListViewModel$getFollowersFromNotification$1 extends SuspendLambda implements p<f0, m0.l.c<? super i>, Object> {
    public int c;
    ...
    public FollowListViewModel$getFollowersFromNotification$1(FollowListViewModel followListViewModel, long j, m0.l.c<? super FollowListViewModel$getFollowersFromNotification$1> cVar) {
        super(2, cVar);
    ...
    public final m0.l.c<i> create(Object obj, m0.l.c<?> cVar) {
        return new FollowListViewModel$getFollowersFromNotification$1(this.d, this.q, cVar);
    }

    public Object invoke(Object obj, Object obj2) {
        f0 f0Var = (f0) obj;
        return new FollowListViewModel$getFollowersFromNotification$1(this.d, this.q, (m0.l.c) obj2).invokeSuspend(i.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            long j = this.q;
            EventRepo eventRepo = userRepo.c;
            b bVar = userRepo.e;
            UserManager userManager = userRepo.f;
            f0 f0Var = userRepo.a;
            v vVar = vVar2;
            v vVar2 = new v(50, 10, false, 50, 0, 0, 52);
            d<w<w<Item>>> h = a.h(new EntityAwarePagingDataSource(eventRepo, userRepo, bVar, userManager, f0Var, new u(vVar, (Object) null, new UserRepo$getFollowersFromNotification$1(userRepo, j), 2)).e, this.d.c);
            ...
            this.c = 1;
            if (m0.r.t.a.r.m.a1.a.E0(h, r3, this) == coroutineSingletons) {
