...
public final class HalfProfileFragment$onViewCreated$$inlined$observeResume$1 implements o {
    public final /* synthetic */ HalfProfileFragment c;

    public HalfProfileFragment$onViewCreated$$inlined$observeResume$1(HalfProfileFragment halfProfileFragment) {
        this.c = halfProfileFragment;
    }

    @a0(Lifecycle.Event.ON_RESUME)
    public final void onResume() {
        v.v2(this.c.U0(), new HalfProfileFragment.a(0, this.c));
    }
}
