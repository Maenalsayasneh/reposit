...
public final class HalfProfileUtil$setUpViews$4$1 extends Lambda implements l<q4, i> {
    public final /* synthetic */ HalfProfileFragment c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HalfProfileUtil$setUpViews$4$1(HalfProfileFragment halfProfileFragment) {
        super(1);
    ...
    public Object invoke(Object obj) {
        ...
        FollowListArgs followListArgs = new FollowListArgs(q4Var.a.getId().intValue(), 0, FollowListType.FOLLOWING, 2);
