...
public abstract class Hilt_EditPhotoFragment extends PhotoCreationFragment implements b {
    public ContextWrapper a2;
    public volatile f b2;
    public final Object c2 = new Object();
    public boolean d2 = false;

    public Hilt_EditPhotoFragment(int i) {
        super(i);
    }
    ...
    public void Q0() {
        if (!this.d2) {
            this.d2 = true;
            ((e4) U()).d0((EditPhotoFragment) this);
        }
    }
