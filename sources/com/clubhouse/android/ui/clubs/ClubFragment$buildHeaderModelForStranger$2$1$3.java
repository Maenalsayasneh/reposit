...
public final class ClubFragment$buildHeaderModelForStranger$2$1$3 extends Lambda implements a<i> {
    public final /* synthetic */ ClubFragment c;
    public final /* synthetic */ GetClubResponse d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ClubFragment$buildHeaderModelForStranger$2$1$3(ClubFragment clubFragment, GetClubResponse getClubResponse) {
        super(0);
        this.c = clubFragment;
