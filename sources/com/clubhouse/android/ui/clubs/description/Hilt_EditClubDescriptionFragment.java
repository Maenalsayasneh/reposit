...
public abstract class Hilt_EditClubDescriptionFragment extends BaseExpandedBottomSheetFragment implements b {
    public ContextWrapper l2;
    public volatile f m2;
    public final Object n2 = new Object();
    public boolean o2 = false;

    public Hilt_EditClubDescriptionFragment(int i) {
        super(i);
    }
    ...
    public void T0() {
        if (!this.o2) {
            this.o2 = true;
            ((i0.e.b.g3.l.w2.b) U()).h((EditClubDescriptionFragment) this);
        }
    }
