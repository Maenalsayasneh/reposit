...
public final class ClubFragment$onViewCreated$10$1 extends Lambda implements l<v1, i> {
    public final /* synthetic */ ClubFragment c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ClubFragment$onViewCreated$10$1(ClubFragment clubFragment) {
        super(1);
        this.c = clubFragment;
    }
    ...
    public Object invoke(Object obj) {
        ...
        if (getClubResponse != null) {
            ...
            if (getClubResponse.d) {
                clubFragment.T0().p(new y1(getClubResponse.c.x));
            }
        }
        return i.a;
    }
