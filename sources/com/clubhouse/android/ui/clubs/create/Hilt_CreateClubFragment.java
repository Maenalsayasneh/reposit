...
public abstract class Hilt_CreateClubFragment extends PhotoCreationFragment implements b {
    public ContextWrapper a2;
    public volatile f b2;
    public final Object c2 = new Object();
    public boolean d2 = false;

    public Hilt_CreateClubFragment(int i) {
        super(i);
    }
    ...
    public void Q0() {
        if (!this.d2) {
            this.d2 = true;
            ((p) U()).m0((CreateClubFragment) this);
        }
    }
