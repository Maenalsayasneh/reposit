...
public abstract class Hilt_ActivityOverflowFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_ActivityOverflowFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((i0.e.b.g3.j.k0.f) U()).r0((ActivityOverflowFragment) this);
        }
    }
