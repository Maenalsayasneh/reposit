...
import h0.q.m0;
import i0.e.b.g3.s.f0;
import i0.j.f.p.h;
import j0.a.a.c.c.f;
import j0.a.b.b;

public abstract class Hilt_AcknowledgePaymentFragment extends BaseBottomSheetFragment implements b {
    public ContextWrapper l2;
    public volatile f m2;
    public final Object n2 = new Object();
    public boolean o2 = false;

    public Hilt_AcknowledgePaymentFragment(int i) {
        super(i);
    }
    ...
    public void T0() {
        if (!this.o2) {
            this.o2 = true;
            ((f0) U()).H((AcknowledgePaymentFragment) this);
        }
    }
