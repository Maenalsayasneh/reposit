...
import i0.b.b.g;
import i0.b.b.h;
import i0.e.b.g3.s.b;
import i0.e.b.g3.s.e;
import i0.e.b.g3.s.f;
...
public final class PaymentsRegistrationFragment extends Hilt_PaymentsRegistrationFragment {
    ...
    public static final class a extends h<PaymentsRegistrationFragment, PaymentsRegistrationViewModel> {
        ...
        public c a(Object obj, k kVar) {
            ...
            i.e(kVar, "property");
            return g.a.b(fragment, kVar, this.a, new PaymentsRegistrationFragment$special$$inlined$fragmentViewModel$default$2$1(this), m.a(r0.class), false, this.b);
        }
    }

    public PaymentsRegistrationFragment() {
        super(R.layout.fragment_payments_registration);
        d a3 = m.a(PaymentsRegistrationViewModel.class);
        this.b2 = new a(a3, false, new PaymentsRegistrationFragment$special$$inlined$fragmentViewModel$default$1(this, a3, a3), a3).a(this, Z1[1]);
    }

    public void J() {
        v.v2(O0(), new PaymentsRegistrationFragment$invalidate$1(this));
    }
    ...
    public final void P0() {
        v.v2(O0(), new PaymentsRegistrationFragment$trackAnalyticsAndNavigateToStripe$1(this));
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(O0().l, new PaymentsRegistrationFragment$onViewCreated$1(this, (m0.l.c<? super PaymentsRegistrationFragment$onViewCreated$1>) null));
        p viewLifecycleOwner = getViewLifecycleOwner();
        i.d(viewLifecycleOwner, "viewLifecycleOwner");
        m0.r.t.a.r.m.a1.a.F2(flowKt__TransformKt$onEach$$inlined$unsafeTransform$1, q.a(viewLifecycleOwner));
        N0().b.setOnClickListener(new i0.e.b.g3.s.g(this));
        Button button = N0().j;
        i.d(button, "binding.retryButton");
        p viewLifecycleOwner2 = getViewLifecycleOwner();
        i.d(viewLifecycleOwner2, "viewLifecycleOwner");
        i0.e.b.d3.k.H(button, q.a(viewLifecycleOwner2), new i0.e.b.g3.s.c(this));
        N0().a.setOnCheckedChangeListener(new e(this));
        N0().h.setOnClickListener(new i0.e.b.g3.s.l(this));
        N0().p.setOnClickListener(new b(this));
        N0().e.setOnClickListener(new i0.e.b.g3.s.d(this));
        N0().f.setOnClickListener(new i0.e.b.g3.s.m(this));
        N0().g.setOnClickListener(new i0.e.b.g3.s.h(this));
        N0().d.setOnClickListener(new f(this));
    }
}
