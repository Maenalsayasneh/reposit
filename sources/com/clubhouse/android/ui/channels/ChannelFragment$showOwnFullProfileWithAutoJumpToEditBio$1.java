...
public final class ChannelFragment$showOwnFullProfileWithAutoJumpToEditBio$1 extends Lambda implements l<i0.e.b.z2.g.l, i> {
    public final /* synthetic */ ChannelFragment c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChannelFragment$showOwnFullProfileWithAutoJumpToEditBio$1(ChannelFragment channelFragment) {
        super(1);
    ...
    public Object invoke(Object obj) {
        ...
        v.f(channelFragment, FragmentName.HALF_PROFILE, new HalfProfileArgs(userInChannel, sourceLocation, true, true, false, 16));
        return i.a;
    }
}
