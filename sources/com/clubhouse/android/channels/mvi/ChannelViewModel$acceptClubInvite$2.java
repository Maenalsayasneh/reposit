...
import i0.e.b.z2.g.m;
import kotlin.jvm.internal.Lambda;
import m0.n.a.p;
import m0.n.b.i;

/* compiled from: ChannelViewModel.kt */
public final class ChannelViewModel$acceptClubInvite$2 extends Lambda implements p<l, b<? extends EmptySuccessResponse>, l> {
    public final /* synthetic */ ChannelViewModel c;
    public final /* synthetic */ Club d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ChannelViewModel$acceptClubInvite$2(ChannelViewModel channelViewModel, Club club) {
        super(2);
    ...
    public Object invoke(Object obj, Object obj2) {
        ...
        if (bVar instanceof f0) {
            ...
            String string = channelViewModel.p.getString(R.string.join_club_success_short, new Object[]{this.d.getName()});
            i.d(string, "resources.getString(R.string.join_club_success_short, club.name)");
