...
public final class SearchUsersPagingSource extends AbstractPagingSource<j> {
    ...
    public SearchUsersPagingSource(FollowScopedSearchRequest followScopedSearchRequest, ServerDataSource serverDataSource, i0.e.a.a aVar) {
    ...
    public java.lang.Object e(int r11, int r12, m0.l.c<? super h0.u.x.b<java.lang.Integer, i0.e.b.b3.b.e.j>> r13) {
        /*
            r10 = this;
            boolean r0 = r13 instanceof com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$1
            if (r0 == 0) goto L_0x0013
            r0 = r13
            com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$1 r0 = (com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$1) r0
            int r1 = r0.x
            ...
            goto L_0x0018
        L_0x0013:
            com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$1 r0 = new com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$1
            r0.<init>(r10, r13)
        L_0x0018:
            ...
            com.clubhouse.android.data.network.paging.SearchUsersPagingSource r11 = (com.clubhouse.android.data.network.paging.SearchUsersPagingSource) r11
            i0.j.f.p.h.d4(r13)
            goto L_0x0053
        L_0x002b:
        ...
        L_0x0033:
            ...
            com.clubhouse.android.data.network.ServerDataSource$searchUsers$2 r2 = new com.clubhouse.android.data.network.ServerDataSource$searchUsers$2
            r9 = 0
            r4 = r2
            r5 = r13
            r7 = r11
        ...
        L_0x0053:
            ...
            com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$response$1 r12 = new com.clubhouse.android.data.network.paging.SearchUsersPagingSource$query$response$1
            r12.<init>(r11)
            r11 = 0
        ...
        L_0x0092:
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.clubhouse.android.data.network.paging.SearchUsersPagingSource.e(int, int, m0.l.c):java.lang.Object");
    }
}
