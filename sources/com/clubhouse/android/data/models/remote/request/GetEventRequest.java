...
public final class GetEventRequest {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u0016\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002HÆ\u0001¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\b"}, d2 = {"Lcom/clubhouse/android/data/models/remote/request/GetEventRequest$Companion;", "", "Lkotlinx/serialization/KSerializer;", "Lcom/clubhouse/android/data/models/remote/request/GetEventRequest;", "serializer", "()Lkotlinx/serialization/KSerializer;", "<init>", "()V", "data_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: GetEventRequest.kt */
    public static final class Companion {
        public Companion() {
        }

        public final KSerializer<GetEventRequest> serializer() {
            return a.a;
        }
    ...
    public static final class a implements v<GetEventRequest> {
        ...
        static {
            a aVar = new a();
            a = aVar;
            PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.clubhouse.android.data.models.remote.request.GetEventRequest", aVar, 4);
        ...
        public java.lang.Object deserialize(kotlinx.serialization.encoding.Decoder r15) {
            ...
            L_0x0084:
                r15.b(r0)
                com.clubhouse.android.data.models.remote.request.GetEventRequest r15 = new com.clubhouse.android.data.models.remote.request.GetEventRequest
                r0 = r1
                ...
                return r15
            */
            throw new UnsupportedOperationException("Method not decompiled: com.clubhouse.android.data.models.remote.request.GetEventRequest.a.deserialize(kotlinx.serialization.encoding.Decoder):java.lang.Object");
        }
        ...
        public void serialize(Encoder encoder, Object obj) {
            ...
            boolean z = false;
            if (c.v(serialDescriptor, 0) || getEventRequest.a != null) {
                c.l(serialDescriptor, 0, e0.b, getEventRequest.a);
            }
            if (c.v(serialDescriptor, 1) || getEventRequest.b != null) {
                c.l(serialDescriptor, 1, g1.b, getEventRequest.b);
            }
            if (c.v(serialDescriptor, 2) || getEventRequest.c != null) {
                c.l(serialDescriptor, 2, g1.b, getEventRequest.c);
            }
            if (c.v(serialDescriptor, 3) || getEventRequest.d != null) {
                z = true;
            }
            if (z) {
                c.l(serialDescriptor, 3, new h0(g1.b, i0.e.b.b3.a.b.c.a.a), getEventRequest.d);
            }
    ...
    public boolean equals(Object obj) {
        ...
        GetEventRequest getEventRequest = (GetEventRequest) obj;
        return i.a(this.a, getEventRequest.a) && i.a(this.b, getEventRequest.b) && i.a(this.c, getEventRequest.c) && i.a(this.d, getEventRequest.d);
    }
    ...
    public String toString() {
        StringBuilder P0 = i0.d.a.a.a.P0("GetEventRequest(eventId=");
        P0.append(this.a);
    ...
    public GetEventRequest(int i, Integer num, String str, String str2, Map map) {
        if ((i & 0) == 0) {
            if ((i & 1) == 0) {
                this.a = null;
            } else {
    ...
    public GetEventRequest(Integer num, String str, String str2, Map<String, ? extends Object> map) {
        this.a = num;
        this.b = str;
        this.c = str2;
        this.d = map;
