...
public final class AcceptClubMemberInviteRequest {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u0016\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002HÆ\u0001¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\b"}, d2 = {"Lcom/clubhouse/android/data/models/remote/request/AcceptClubMemberInviteRequest$Companion;", "", "Lkotlinx/serialization/KSerializer;", "Lcom/clubhouse/android/data/models/remote/request/AcceptClubMemberInviteRequest;", "serializer", "()Lkotlinx/serialization/KSerializer;", "<init>", "()V", "data_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: AcceptClubMemberInviteRequest.kt */
    public static final class Companion {
        public Companion() {
        }

        public final KSerializer<AcceptClubMemberInviteRequest> serializer() {
            return a.a;
        }
    ...
    public static final class a implements v<AcceptClubMemberInviteRequest> {
        ...
        public Object deserialize(Decoder decoder) {
            ...
            return new AcceptClubMemberInviteRequest(i, i2, (Integer) obj);
        }
        ...
        public void serialize(Encoder encoder, Object obj) {
            ...
            boolean z = false;
            c.q(serialDescriptor, 0, acceptClubMemberInviteRequest.a);
            if (c.v(serialDescriptor, 1) || acceptClubMemberInviteRequest.b != null) {
                z = true;
            }
            if (z) {
                c.l(serialDescriptor, 1, e0.b, acceptClubMemberInviteRequest.b);
            }
            c.b(serialDescriptor);
        }
    ...
    public AcceptClubMemberInviteRequest(int i, int i2, Integer num) {
        if (1 == (i & 1)) {
            this.a = i2;
            if ((i & 2) == 0) {
                this.b = null;
    ...
    public String toString() {
        StringBuilder P0 = i0.d.a.a.a.P0("AcceptClubMemberInviteRequest(clubId=");
        P0.append(this.a);
