...
public final class CallPhoneNumberAuthResponse {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u0016\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002HÆ\u0001¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\b"}, d2 = {"Lcom/clubhouse/android/data/models/remote/response/CallPhoneNumberAuthResponse$Companion;", "", "Lkotlinx/serialization/KSerializer;", "Lcom/clubhouse/android/data/models/remote/response/CallPhoneNumberAuthResponse;", "serializer", "()Lkotlinx/serialization/KSerializer;", "<init>", "()V", "data_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: CallPhoneNumberAuthResponse.kt */
    public static final class Companion {
        public Companion() {
        }

        public final KSerializer<CallPhoneNumberAuthResponse> serializer() {
            return a.a;
        }
    ...
    public static final class a implements v<CallPhoneNumberAuthResponse> {
        ...
        public Object deserialize(Decoder decoder) {
            ...
            return new CallPhoneNumberAuthResponse(i, z, i2);
        }
        ...
        public void serialize(Encoder encoder, Object obj) {
            ...
            c.r(serialDescriptor, 0, callPhoneNumberAuthResponse.a);
            c.q(serialDescriptor, 1, callPhoneNumberAuthResponse.b);
            c.b(serialDescriptor);
        }
    ...
    public CallPhoneNumberAuthResponse(int i, boolean z, int i2) {
        if (3 == (i & 3)) {
            this.a = z;
            this.b = i2;
            return;
    ...
    public String toString() {
        StringBuilder P0 = i0.d.a.a.a.P0("CallPhoneNumberAuthResponse(isVerified=");
        P0.append(this.a);
