...
public final class GetProfileResponse {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0006\u0010\u0007J\u0016\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002HÆ\u0001¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\b"}, d2 = {"Lcom/clubhouse/android/data/models/remote/response/GetProfileResponse$Companion;", "", "Lkotlinx/serialization/KSerializer;", "Lcom/clubhouse/android/data/models/remote/response/GetProfileResponse;", "serializer", "()Lkotlinx/serialization/KSerializer;", "<init>", "()V", "data_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: GetProfileResponse.kt */
    ...
    public static final class a implements v<GetProfileResponse> {
        ...
        public KSerializer<?>[] childSerializers() {
            return new KSerializer[]{UserProfile.a.a};
        }
        ...
        public Object deserialize(Decoder decoder) {
            ...
            int i = 1;
            if (c.y()) {
                obj = c.m(serialDescriptor, 0, UserProfile.a.a, null);
            } else {
                int i2 = 0;
                while (i != 0) {
                    ...
                    if (x == -1) {
                        ...
                        obj = c.m(serialDescriptor, 0, UserProfile.a.a, obj);
                        i2 |= 1;
                    } else {
            ...
            return new GetProfileResponse(i, (UserProfile) obj);
        }
        ...
        public void serialize(Encoder encoder, Object obj) {
            ...
            c.z(serialDescriptor, 0, UserProfile.a.a, getProfileResponse.a);
            c.b(serialDescriptor);
        }
    ...
    public GetProfileResponse(int i, UserProfile userProfile) {
        if (1 == (i & 1)) {
            this.a = userProfile;
            return;
        }
    ...
    public String toString() {
        StringBuilder P0 = i0.d.a.a.a.P0("GetProfileResponse(user=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
