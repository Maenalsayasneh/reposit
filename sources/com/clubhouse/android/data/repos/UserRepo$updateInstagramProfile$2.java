...
public final class UserRepo$updateInstagramProfile$2 extends Lambda implements l<UpdateInstagramProfileResponse, i> {
    public final /* synthetic */ UserRepo c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public UserRepo$updateInstagramProfile$2(UserRepo userRepo) {
        super(1);
        this.c = userRepo;
    }
