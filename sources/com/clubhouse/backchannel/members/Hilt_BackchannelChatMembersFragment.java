...
public abstract class Hilt_BackchannelChatMembersFragment extends BaseExpandedBottomSheetFragment implements b {
    public ContextWrapper l2;
    public volatile f m2;
    public final Object n2 = new Object();
    public boolean o2 = false;

    public Hilt_BackchannelChatMembersFragment(int i) {
        super(i);
    }
    ...
    public void T0() {
        if (!this.o2) {
            this.o2 = true;
            ((n) U()).s0((BackchannelChatMembersFragment) this);
        }
    }
