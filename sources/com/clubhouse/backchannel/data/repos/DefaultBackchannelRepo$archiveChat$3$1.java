...
public final class DefaultBackchannelRepo$archiveChat$3$1 extends Lambda implements l<Chat, Chat> {
    public final /* synthetic */ DefaultBackchannelRepo c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DefaultBackchannelRepo$archiveChat$3$1(DefaultBackchannelRepo defaultBackchannelRepo) {
        super(1);
