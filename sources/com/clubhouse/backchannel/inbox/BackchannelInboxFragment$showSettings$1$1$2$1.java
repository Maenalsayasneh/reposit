...
public final class BackchannelInboxFragment$showSettings$1$1$2$1 extends Lambda implements a<i> {
    public final /* synthetic */ BackchannelInboxFragment c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BackchannelInboxFragment$showSettings$1$1$2$1(BackchannelInboxFragment backchannelInboxFragment) {
        super(0);
    ...
    public Object invoke() {
        ...
        backchannelInboxFragment.P0().p(new n(false));
        return i.a;
    }
}
