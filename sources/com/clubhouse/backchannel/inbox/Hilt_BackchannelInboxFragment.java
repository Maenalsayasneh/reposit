...
public abstract class Hilt_BackchannelInboxFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_BackchannelInboxFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((j) U()).G0((BackchannelInboxFragment) this);
        }
    }
