...
public abstract class Hilt_BackchannelChatFragment extends BaseFragment implements b {
    public boolean Y1 = false;
    public ContextWrapper q;
    public volatile f x;
    public final Object y = new Object();

    public Hilt_BackchannelChatFragment(int i) {
        super(i);
    }
    ...
    public void M0() {
        if (!this.Y1) {
            this.Y1 = true;
            ((x) U()).R((BackchannelChatFragment) this);
        }
    }
