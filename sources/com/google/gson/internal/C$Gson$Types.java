    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder P0 = a.P0("? super ");
                P0.append(C$Gson$Types.typeToString(this.lowerBound));
                return P0.toString();
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                StringBuilder P02 = a.P0("? extends ");
                P02.append(C$Gson$Types.typeToString(this.upperBound));
                return P02.toString();
            }
        }
    }
