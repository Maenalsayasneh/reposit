...
public final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder P0 = a.P0("DefaultDateTypeAdapter(");
            P0.append(((SimpleDateFormat) dateFormat).toPattern());
            P0.append(')');
            return P0.toString();
        }
        StringBuilder P02 = a.P0("DefaultDateTypeAdapter(");
        P02.append(dateFormat.getClass().getSimpleName());
        P02.append(')');
        return P02.toString();
    }
