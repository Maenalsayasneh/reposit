...
public class PlayCoreMissingSplitsActivity extends Activity implements DialogInterface.OnClickListener {
    public final void onClick(DialogInterface dialogInterface, int i) {
        if (i == -1) {
            ...
            try {
                startActivity(new Intent("android.intent.action.VIEW").setData(Uri.parse(a.z0(new StringBuilder(String.valueOf(packageName).length() + 66), "market://details?id=", packageName, "&referrer=utm_source%3Dplay.core.missingsplits"))).setPackage("com.android.vending"));
                ...
                if (Log.isLoggable("PlayCore", 6)) {
                    Log.e("PlayCore", f.c(concat, "Couldn't start missing splits activity for %s", objArr), e);
                }
            }
        }
        finish();
