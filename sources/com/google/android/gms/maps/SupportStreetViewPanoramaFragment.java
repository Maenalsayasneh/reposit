...
public class SupportStreetViewPanoramaFragment extends Fragment {
    ...
    public static class a implements c {
        ...
        public final void j(Activity activity, Bundle bundle, Bundle bundle2) {
            try {
                ...
                m.b(bundle2, bundle3);
                this.b.G(new i0.h.a.b.d.d(activity), (StreetViewPanoramaOptions) null, bundle3);
                m.b(bundle3, bundle2);
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
            }
        ...
        public final View k(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            try {
                Bundle bundle2 = new Bundle();
                m.b(bundle, bundle2);
                i0.h.a.b.d.b k = this.b.k(new i0.h.a.b.d.d(layoutInflater), new i0.h.a.b.d.d(viewGroup), bundle2);
                m.b(bundle2, bundle);
                return (View) i0.h.a.b.d.d.j0(k);
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
            }
        }
    ...
    public static class b extends i0.h.a.b.d.a<a> {
        ...
        public final void a(i0.h.a.b.d.e<a> eVar) {
            this.f = eVar;
            e();
        }
        ...
        public final void e() {
            ...
            if (activity != null && this.f != null && this.a == null) {
                try {
                    ...
                    e T = n.a(this.g).T(new i0.h.a.b.d.d(this.g));
                    ((f) this.f).a(new a(this.e, T));
                    for (d a : this.h) {
                        ((a) this.a).a(a);
                    }
                    this.h.clear();
    ...
    public void onResume() {
        super.onResume();
        b bVar = this.c;
        bVar.d((Bundle) null, new i0.h.a.b.d.k(bVar));
    }
