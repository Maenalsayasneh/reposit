...
public final class ShareCompat {
        ...
        public Intent getIntent() {
            ...
            if (!z) {
                ...
                if (arrayList5 == null || arrayList5.isEmpty()) {
                    ...
                    a.e0(this.mIntent, this.mStreams);
                }
            } else {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            StringBuilder P0 = i0.d.a.a.a.P0("Stream items available: ");
            P0.append(getStreamCount());
            P0.append(" index requested: ");
            P0.append(i);
    ...
    public static void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
        ...
        StringBuilder P0 = i0.d.a.a.a.P0(HISTORY_FILENAME_PREFIX);
        P0.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(P0.toString());
    ...
    public static void configureMenuItem(Menu menu, int i, IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(i0.d.a.a.a.g0("Could not find menu item with id ", i, " in the supplied menu"));
    }
}
