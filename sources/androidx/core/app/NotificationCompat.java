...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Builder(int i, CharSequence charSequence, PendingIntent pendingIntent) {
                this(i != 0 ? IconCompat.c((Resources) null, "", i) : null, charSequence, pendingIntent, new Bundle(), (RemoteInput[]) null, true, 0, true, false);
            }
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent) {
            this(i != 0 ? IconCompat.c((Resources) null, "", i) : null, charSequence, pendingIntent);
        }
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i = this.icon) != 0) {
                this.mIcon = IconCompat.c((Resources) null, "", i);
            }
            return this.mIcon;
        }
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z, int i2, boolean z2, boolean z3) {
            this(i != 0 ? IconCompat.c((Resources) null, "", i) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z, i2, z2, z3);
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            iconCompat.c = (Bitmap) parcelable;
            return iconCompat;
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (this.mBigLargeIconSet) {
                ...
                if (iconCompat == null) {
                    ...
                    if (notificationBuilderWithBuilderAccessor instanceof c) {
                        context = ((c) notificationBuilderWithBuilderAccessor).a;
                    }
                    b.a(bigPicture, iconCompat.o(context));
                }
            }
    ...
    public static class Builder {
        ...
        public RemoteViews createBigContentView() {
            ...
            c cVar = new c(this);
            Style style = this.mStyle;
            if (style != null && (makeBigContentView = style.makeBigContentView(cVar)) != null) {
                return makeBigContentView;
            }
            return Notification.Builder.recoverBuilder(this.mContext, cVar.a()).createBigContentView();
        }
        ...
        public RemoteViews createContentView() {
            ...
            c cVar = new c(this);
            Style style = this.mStyle;
            if (style != null && (makeContentView = style.makeContentView(cVar)) != null) {
                return makeContentView;
            }
            return Notification.Builder.recoverBuilder(this.mContext, cVar.a()).createContentView();
        }
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            c cVar = new c(this);
            Style style = this.mStyle;
            if (style != null && (makeHeadsUpContentView = style.makeHeadsUpContentView(cVar)) != null) {
                return makeHeadsUpContentView;
            }
            return Notification.Builder.recoverBuilder(this.mContext, cVar.a()).createHeadsUpContentView();
        }
        ...
        public Builder setShortcutInfo(h0.i.b.c.a aVar) {
            if (aVar == null) {
                return this;
            }
            throw null;
    ...
    public static abstract class Style {
        ...
        private Bitmap createColoredBitmap(int i, int i2, int i3) {
            ...
            PorterDuff.Mode mode = IconCompat.a;
            if (context != null) {
                return createColoredBitmap(IconCompat.c(context.getResources(), context.getPackageName(), i), i2, i3);
            }
        ...
        private Bitmap createColoredBitmap(IconCompat iconCompat, int i, int i2) {
            ...
            if (iconCompat.b == 2 && (obj = iconCompat.c) != null) {
                ...
                if (str.contains(":")) {
                    ...
                    if ("0_resource_name_obfuscated".equals(str4)) {
                        ...
                        int identifier = IconCompat.h(context, f).getIdentifier(str4, str3, str5);
            ...
            Drawable loadDrawable = iconCompat.o(context).loadDrawable(context);
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (action.getIcon() == null && (i2 = action2.icon) != 0) {
            return new Action(i2, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, z4);
        }
        if (action.getIcon() != null) {
        ...
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, z4);
    }
    ...
    public static List<Action> getInvisibleActions(Notification notification) {
        ...
        if (!(bundle2 == null || (bundle = bundle2.getBundle(CarExtender.EXTRA_INVISIBLE_ACTIONS)) == null)) {
            for (int i = 0; i < bundle.size(); i++) {
                arrayList.add(d.b(bundle.getBundle(Integer.toString(i))));
            }
        }
        return arrayList;
    }
    ...
    public static b getLocusId(Notification notification) {
        ...
        if (locusId != null) {
            g0.a.b.b.a.m(locusId, "locusId cannot be null");
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            CharSequence d = c.d(name);
            spannableStringBuilder.append(d);
            spannableStringBuilder.setSpan(makeFontColorSpan(i), spannableStringBuilder.length() - d.length(), spannableStringBuilder.length(), 33);
            if (message.getText() != null) {
                charSequence = message.getText();
            }
            spannableStringBuilder.append("  ").append(c.d(charSequence));
