...
public class SignatureSpi extends java.security.SignatureSpi implements n, y0 {
    ...
    private k signer = new s0.a.b.n0.k();
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof ECPublicKey) {
            bVar = ECUtil.generatePublicKeyParameter(publicKey);
        } else if (publicKey instanceof c) {
            bVar = GOST3410Util.generatePublicKeyParameter(publicKey);
        } else {
            try {
                PublicKey publicKey2 = BouncyCastleProvider.getPublicKey(m0.s(publicKey.getEncoded()));
                if (publicKey2 instanceof ECPublicKey) {
                    bVar = ECUtil.generatePublicKeyParameter(publicKey2);
                } else {
