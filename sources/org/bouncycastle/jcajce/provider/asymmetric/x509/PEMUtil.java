...
public class PEMUtil {
    ...
    public class Boundaries {
        ...
        private Boundaries(String str) {
            this._header = a.o0("-----BEGIN ", str, "-----");
            this._footer = a.o0("-----END ", str, "-----");
        }
    ...
    public PEMUtil(String str) {
        this._supportedBoundaries = new Boundaries[]{new Boundaries(str), new Boundaries(a.n0("X509 ", str)), new Boundaries("PKCS7")};
    }
    ...
    public s readPEMObject(InputStream inputStream) throws IOException {
        ...
        if (boundaries != null) {
            ...
            if (boundaries2 == null) {
                ...
                try {
                    return s.B(s0.a.g.k.a.a(stringBuffer.toString()));
