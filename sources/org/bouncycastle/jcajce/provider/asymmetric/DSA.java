...
public class DSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addSignatureAlgorithm(configurableProvider2, "SHA384", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsa384", b.U);
            ConfigurableProvider configurableProvider3 = configurableProvider;
            addSignatureAlgorithm(configurableProvider3, "SHA512", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsa512", b.V);
            addSignatureAlgorithm(configurableProvider2, "SHA3-224", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_224", b.W);
            addSignatureAlgorithm(configurableProvider3, "SHA3-256", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_256", b.X);
            addSignatureAlgorithm(configurableProvider2, "SHA3-384", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_384", b.Y);
            addSignatureAlgorithm(configurableProvider3, "SHA3-512", "DSA", "org.bouncycastle.jcajce.provider.asymmetric.dsa.DSASigner$dsaSha3_512", b.Z);
            ...
            int i = 0;
            while (true) {
                n[] nVarArr = DSAUtil.dsaOids;
                if (i != nVarArr.length) {
                    a.w(a.P0("Alg.Alias.Signature."), nVarArr[i], configurableProvider, "DSA");
                    registerOid(configurableProvider, nVarArr[i], "DSA", keyFactorySpi);
                    registerOidAlgorithmParameterGenerator(configurableProvider, nVarArr[i], "DSA");
                    i++;
                } else {
                    return;
                }
