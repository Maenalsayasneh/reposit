...
public class BcKeyStoreSpi extends KeyStoreSpi {
    ...
    public static class BouncyCastleStore extends BcKeyStoreSpi {
            ...
            if (inputStream != null) {
                ...
                if (readInt == 2 || readInt == 0 || readInt == 1) {
                    ...
                    if (readInt2 == 20) {
                        ...
                        s0.a.c.m.a aVar = new s0.a.c.m.a(dataInputStream, makePBECipher(readInt == 0 ? "OldPBEWithSHAAndTwofish-CBC" : BcKeyStoreSpi.STORE_CIPHER, 2, cArr, bArr, readInt3));
                        v vVar = new v();
                        loadStore(new s0.a.b.g0.a(aVar, vVar));
                        byte[] bArr2 = new byte[20];
                        vVar.doFinal(bArr2, 0);
                        byte[] bArr3 = new byte[20];
                        s0.a.g.l.a.b(aVar, bArr3, 0, 20);
                        if (!h3.U(bArr2, bArr3)) {
                            this.table.clear();
        ...
        public void engineStore(OutputStream outputStream, char[] cArr) throws IOException {
            ...
            s0.a.b.g0.b bVar2 = new s0.a.b.g0.b(new v());
            saveStore(new s0.a.g.l.b(bVar, bVar2));
            byte[] bArr2 = new byte[bVar2.c.getDigestSize()];
            bVar2.c.doFinal(bArr2, 0);
            bVar.write(bArr2);
            bVar.close();
        }
    }
    ...
    public class StoreEntry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
            r2 = org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.access$100(r10.this$0, new java.io.DataInputStream(new s0.a.c.m.a(r2, r10.this$0.makePBECipher("BrokenPBEWithSHAAnd3-KeyTripleDES-CBC", 2, r11, r1, r9))));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:?, code lost:
            ...
            r2.readFully(r1);
            r9 = r2.readInt();
            r2 = org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.access$100(r10.this$0, new java.io.DataInputStream(new s0.a.c.m.a(r2, r10.this$0.makePBECipher("OldPBEWithSHAAnd3-KeyTripleDES-CBC", 2, r11, r1, r9))));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x00bd, code lost:
            ...
            r9.write(r7);
            r9.writeInt(r8);
            r11 = new java.io.DataOutputStream(new s0.a.c.m.b(r9, r10.this$0.makePBECipher(org.bouncycastle.jcajce.provider.keystore.bc.BcKeyStoreSpi.KEY_CIPHER, 1, r11, r7, r8)));
        ...
        public java.lang.Object getObject(char[] r11) throws java.security.NoSuchAlgorithmException, java.security.UnrecoverableKeyException {
            ...
            L_0x000e:
                ...
                s0.a.c.m.a r3 = new s0.a.c.m.a     // Catch:{ Exception -> 0x00fa }
            ...
            L_0x0049:
                ...
                s0.a.c.m.a r4 = new s0.a.c.m.a     // Catch:{ Exception -> 0x00fa }
            ...
            L_0x00bb:
                ...
                s0.a.c.m.b r3 = new s0.a.c.m.b     // Catch:{ Exception -> 0x00fa }
    ...
    private Certificate decodeCertificate(DataInputStream dataInputStream) throws IOException {
        ...
        dataInputStream.readFully(bArr);
        try {
            return this.helper.e(readUTF).generateCertificate(new ByteArrayInputStream(bArr));
    ...
    public Key decodeKey(DataInputStream dataInputStream) throws IOException {
        ...
        if (readUTF.equals("PKCS#8") || readUTF.equals("PKCS8")) {
            ...
            throw new IOException(i0.d.a.a.a.o0("Key format ", readUTF, " not recognised!"));
        }
        if (read == 0) {
            return BouncyCastleProvider.getPrivateKey(p.s(bArr));
        }
        if (read == 1) {
            return BouncyCastleProvider.getPublicKey(m0.s(bArr));
        }
        if (read == 2) {
            try {
                return this.helper.g(readUTF2).generateSecret(keySpec);
            } catch (Exception e) {
                throw new IOException(i0.d.a.a.a.b0(e, i0.d.a.a.a.P0("Exception creating key: ")));
            }
        } else {
            ...
            if (readInt == 2 || readInt == 0 || readInt == 1) {
                ...
                if (readInt2 > 0) {
                    ...
                    if (cArr == null || cArr.length == 0) {
                        ...
                        dataInputStream.readFully(new byte[gVar.c]);
                        return;
                    }
                    byte[] PKCS12PasswordToBytes = t.PKCS12PasswordToBytes(cArr);
                    s0.a.b.f0.t tVar = new s0.a.b.f0.t(new v());
                    tVar.init(PKCS12PasswordToBytes, bArr, readInt3);
                    i generateDerivedMacParameters = tVar.generateDerivedMacParameters(readInt != 2 ? gVar.c : gVar.c * 8);
                    Arrays.fill(PKCS12PasswordToBytes, (byte) 0);
                    gVar.init(generateDerivedMacParameters);
                    loadStore(new s0.a.b.g0.c(dataInputStream, gVar));
                    byte[] bArr2 = new byte[gVar.c];
                    gVar.doFinal(bArr2, 0);
                    byte[] bArr3 = new byte[gVar.c];
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        throw new KeyStoreException(i0.d.a.a.a.n0("key store already has a key entry with alias ", str));
    }
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws IOException {
        ...
        s0.a.b.f0.t tVar = new s0.a.b.f0.t(new v());
        byte[] PKCS12PasswordToBytes = t.PKCS12PasswordToBytes(cArr);
        tVar.init(PKCS12PasswordToBytes, bArr, nextInt);
        gVar.init(tVar.generateDerivedMacParameters(this.version < 2 ? gVar.c : gVar.c * 8));
        for (int i = 0; i != PKCS12PasswordToBytes.length; i++) {
            PKCS12PasswordToBytes[i] = 0;
        }
        saveStore(new s0.a.g.l.b(dataOutputStream, dVar));
        byte[] bArr2 = new byte[gVar.c];
        gVar.doFinal(bArr2, 0);
    ...
    public Cipher makePBECipher(String str, int i, char[] cArr, byte[] bArr, int i2) throws IOException {
        try {
            ...
            c.init(i, g.generateSecret(pBEKeySpec), pBEParameterSpec);
            return c;
        } catch (Exception e) {
