...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded(String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                return i == -1 ? new q(engineGetEncoded()).getEncoded() : new q(i, engineGetEncoded()).getEncoded();
        ...
        public void engineInit(byte[] bArr, String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                q qVar = x instanceof q ? (q) x : x != null ? new q(s.B(x)) : null;
                k kVar = qVar.c;
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            s0.a.a.n nVar2 = n.J;
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", nVar2, "PBEWITHMD2ANDRC2");
            s0.a.a.n nVar3 = n.L;
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", nVar3, "PBEWITHMD5ANDRC2");
            s0.a.a.n nVar4 = n.N;
            configurableProvider.addAlgorithm("Alg.Alias.SecretKeyFactory", nVar4, "PBEWITHSHA1ANDRC2");
            i0.d.a.a.a.u(i0.d.a.a.a.Y0(i0.d.a.a.a.Y0(i0.d.a.a.a.Y0(i0.d.a.a.a.Y0(i0.d.a.a.a.f1(configurableProvider, "Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.5", "PBEWITHSHAAND128BITRC2-CBC", "Alg.Alias.SecretKeyFactory.1.2.840.113549.1.12.1.6", "PBEWITHSHAAND40BITRC2-CBC"), str, "$PBEWithMD2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD2ANDRC2"), str, "$PBEWithMD5KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD5ANDRC2"), str, "$PBEWithSHA1KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHA1ANDRC2"), str, "$PBEWithSHAAnd128BitKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND128BITRC2-CBC"), str, "$PBEWithSHAAnd40BitKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAAND40BITRC2-CBC");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", nVar2, "PBEWITHMD2ANDRC2");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", nVar3, "PBEWITHMD5ANDRC2");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", nVar4, "PBEWITHSHA1ANDRC2");
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", n.K0, "PBEWITHSHAAND128BITRC2-CBC");
            configurableProvider.addAlgorithm("Alg.Alias.Cipher", n.L0, "PBEWITHSHAAND40BITRC2-CBC");
            i0.d.a.a.a.u(i0.d.a.a.a.f1(configurableProvider, "Alg.Alias.Cipher.PBEWITHSHA1AND128BITRC2-CBC", "PBEWITHSHAAND128BITRC2-CBC", "Alg.Alias.Cipher.PBEWITHSHA1AND40BITRC2-CBC", "PBEWITHSHAAND40BITRC2-CBC"), str, "$PBEWithSHA1AndRC2", configurableProvider, "Cipher.PBEWITHSHA1ANDRC2");
            i0.d.a.a.a.u(i0.d.a.a.a.Y0(i0.d.a.a.a.Y0(i0.d.a.a.a.f1(configurableProvider, "Alg.Alias.Cipher.PBEWITHSHAANDRC2-CBC", "PBEWITHSHA1ANDRC2", "Alg.Alias.Cipher.PBEWITHSHA1ANDRC2-CBC", "PBEWITHSHA1ANDRC2"), str, "$PBEWithSHAAnd128BitRC2", configurableProvider, "Cipher.PBEWITHSHAAND128BITRC2-CBC"), str, "$PBEWithSHAAnd40BitRC2", configurableProvider, "Cipher.PBEWITHSHAAND40BITRC2-CBC"), str, "$PBEWithMD5AndRC2", configurableProvider, "Cipher.PBEWITHMD5ANDRC2");
    ...
    public static class PBEWithMD2KeyFactory extends PBESecretKeyFactory {
        public PBEWithMD2KeyFactory() {
            super("PBEwithMD2andRC2", n.J, true, 0, 5, 64, 64);
        }
    }
    ...
    public static class PBEWithMD5KeyFactory extends PBESecretKeyFactory {
        public PBEWithMD5KeyFactory() {
            super("PBEwithMD5andRC2", n.L, true, 0, 0, 64, 64);
        }
    }
    ...
    public static class PBEWithSHA1KeyFactory extends PBESecretKeyFactory {
        public PBEWithSHA1KeyFactory() {
            super("PBEwithSHA1andRC2", n.N, true, 0, 1, 64, 64);
        }
    }

    public static class PBEWithSHAAnd128BitKeyFactory extends PBESecretKeyFactory {
        public PBEWithSHAAnd128BitKeyFactory() {
            super("PBEwithSHAand128BitRC2-CBC", n.K0, true, 2, 1, 128, 64);
        }
    }
    ...
    public static class PBEWithSHAAnd40BitKeyFactory extends PBESecretKeyFactory {
        public PBEWithSHAAnd40BitKeyFactory() {
            super("PBEwithSHAand40BitRC2-CBC", n.L0, true, 2, 1, 40, 64);
        }
    }
