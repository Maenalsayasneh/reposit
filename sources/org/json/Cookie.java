...
public class Cookie {
    ...
    public static JSONObject toJSONObject(String str) throws JSONException {
        ...
        jSONTokener.next('=');
        jSONObject.put(InstabugDbContract.UserAttributesEntry.COLUMN_VALUE, (Object) jSONTokener.nextTo(';'));
        jSONTokener.next();
    ...
    public static String toString(JSONObject jSONObject) throws JSONException {
        ...
        sb.append("=");
        sb.append(escape(jSONObject.getString(InstabugDbContract.UserAttributesEntry.COLUMN_VALUE)));
