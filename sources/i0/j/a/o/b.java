...
/* compiled from: APMHttpsUrlConnection */
public class b extends HttpsURLConnection implements a.C0157a {
    public final i0.j.a.n.a.a a = i0.j.a.g.a.i();
    public HttpsURLConnection b;
    public long c;
    public long d;
    public i0.j.a.o.c.b e;
    ...
    public InputStream getErrorStream() {
        ...
        if (this.b.getContentLength() < 0) {
            ...
            if (errorStream == null) {
                ...
                inputStream = new a(errorStream, this);
            }
        } else {
    ...
    public OutputStream getOutputStream() throws IOException {
        try {
            if (this.e == null) {
                this.e = new i0.j.a.o.c.b(this.b.getOutputStream());
            }
            return this.e;
        } catch (IOException e2) {
            this.g.setErrorMessage(e2.getClass().getSimpleName());
