...
public final class e {
    ...
    public static NumberFormatException a(String str) {
        return new NumberFormatException(a.o0("Value \"", str, "\" can not be represented as BigDecimal"));
    }
    ...
    public static int d(java.lang.String r9) {
        ...
        L_0x0084:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.f.a.b.i.e.d(java.lang.String):int");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:0x003c, code lost:
        r0 = r0 + ((r2[r3] - '0') * com.instabug.library.networkv2.connection.InstabugBaseConnectionManagerImpl.DEFAULT_READ_TIME_OUT);
        r3 = r3 + 1;
     */
    ...
    public static int e(char[] r2, int r3, int r4) {
        ...
        L_0x0061:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.f.a.b.i.e.e(char[], int, int):int");
    }
    ...
    public static long g(char[] cArr, int i, int i2) {
        int i3 = i2 - 9;
        return (((long) e(cArr, i, i3)) * 1000000000) + ((long) e(cArr, i + i3, 9));
    }
}
