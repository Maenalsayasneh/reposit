...
public final class f {
    ...
    public static String c(String str, String str2, @Nullable Object... objArr) {
        ...
        return a.z0(new StringBuilder(String.valueOf(str).length() + 3 + String.valueOf(str2).length()), str, " : ", str2);
    }
    ...
    public final int b(int i, String str, @Nullable Object[] objArr) {
