...
public class e extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.q && measuredWidth > i7) {
                    i9 = this.c + paddingTop;
                    this.x++;
                    i8 = paddingRight;
                }
                childAt.setTag(R.id.row_index_key, Integer.valueOf(this.x - 1));
                int i11 = i8 + i5;
                ...
                i8 += childAt.getMeasuredWidth() + i5 + i6 + this.d;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int measuredWidth2 = childAt.getMeasuredWidth() + i4 + i5 + this.d + paddingLeft;
    ...
    public e(Context context, AttributeSet attributeSet, int i) {
        ...
        this.c = obtainStyledAttributes.getDimensionPixelSize(R.styleable.FlowLayout_lineSpacing, 0);
        this.d = obtainStyledAttributes.getDimensionPixelSize(R.styleable.FlowLayout_itemSpacing, 0);
