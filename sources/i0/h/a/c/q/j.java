...
public final class j {
    ...
    public static void b(android.content.Context r4, android.util.AttributeSet r5, int[] r6, int r7, int r8, int... r9) {
        ...
        L_0x0044:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.h.a.c.q.j.b(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
    ...
    public static void c(Context context, int[] iArr, String str) {
        ...
        if (!z) {
            throw new IllegalArgumentException(a.o0("The style on this component requires your app theme to be ", str, " (or a descendant)."));
        }
    }
