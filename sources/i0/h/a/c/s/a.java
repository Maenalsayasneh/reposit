...
public class a extends p {
    public static final int x = R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public a(android.content.Context r8, android.util.AttributeSet r9) {
        ...
        L_0x0029:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.h.a.c.s.a.<init>(android.content.Context, android.util.AttributeSet):void");
    }

    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.Y1 == null) {
            int L = b.L(this, R.attr.colorControlActivated);
            int L2 = b.L(this, R.attr.colorOnSurface);
            int L3 = b.L(this, R.attr.colorSurface);
            int[][] iArr = y;
            int[] iArr2 = new int[iArr.length];
            iArr2[0] = b.b0(L3, L, 1.0f);
            iArr2[1] = b.b0(L3, L2, 0.54f);
            iArr2[2] = b.b0(L3, L2, 0.38f);
            iArr2[3] = b.b0(L3, L2, 0.38f);
