...
public class b {
    ...
    public b(i0.h.c.c r4) {
        ...
        L_0x0049:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.h.c.r.p.b.<init>(i0.h.c.c):void");
    }
    ...
    public final String a() {
        ...
        synchronized (this.b) {
            str = null;
            String string = this.b.getString("|S||P|", (String) null);
            if (string == null) {
                return null;
            }
            try {
