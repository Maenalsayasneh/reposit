...
public class d {
    ...
    public synchronized void b(int r7) {
        ...
        L_0x0022:
            int r0 = r6.e     // Catch:{ all -> 0x006e }
            int r0 = r0 + r2
            r6.e = r0     // Catch:{ all -> 0x006e }
            monitor-enter(r6)     // Catch:{ all -> 0x006e }
        ...
        L_0x003d:
            ...
            double r0 = r0 + r2
            long r2 = b     // Catch:{ all -> 0x003b }
            double r2 = (double) r2     // Catch:{ all -> 0x003b }
            double r0 = java.lang.Math.min(r0, r2)     // Catch:{ all -> 0x003b }
            long r0 = (long) r0
            monitor-exit(r6)     // Catch:{ all -> 0x006e }
        L_0x0061:
            i0.h.c.r.n r7 = r6.c     // Catch:{ all -> 0x006e }
            long r2 = r7.a()     // Catch:{ all -> 0x006e }
            long r2 = r2 + r0
            r6.d = r2     // Catch:{ all -> 0x006e }
            monitor-exit(r6)
            return
        L_0x006c:
            monitor-exit(r6)     // Catch:{ all -> 0x006e }
        ...
        L_0x006e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.h.c.r.q.d.b(int):void");
    }
}
