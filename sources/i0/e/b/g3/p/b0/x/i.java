...
import i0.e.b.g3.p.b0.x.g;
import java.util.Objects;
import m0.n.a.a;

/* compiled from: BuddyListUserInClub_ */
public class i extends g implements z<g.a>, h {
    ...
    public boolean equals(Object obj) {
        ...
        if (onClickListener == null ? iVar.l != null : !onClickListener.equals(iVar.l)) {
            return false;
        }
        a<m0.i> aVar = this.i;
    ...
    public int o() {
        return R.layout.buddy_list_user_in_club;
    }
    ...
    public String toString() {
        StringBuilder P0 = i0.d.a.a.a.P0("BuddyListUserInClub_{name=");
        P0.append(this.j);
        P0.append(", photoUrl=");
        P0.append(this.k);
