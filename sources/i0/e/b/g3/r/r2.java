...
public final class r2 implements l {
    ...
    public r2(CollectNameArgs collectNameArgs) {
    ...
    public int b() {
        return R.id.action_waitlistFragment_to_collectNameFragment;
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionWaitlistFragmentToCollectNameFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
