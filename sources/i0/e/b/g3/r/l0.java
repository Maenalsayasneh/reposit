...
public final class l0 implements l {
    ...
    public l0(CollectUsernameArgs collectUsernameArgs) {
    ...
    public int b() {
        return R.id.action_collectNameFragment_to_collectUsernameFragment;
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionCollectNameFragmentToCollectUsernameFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
