...
public final class k2 implements l {
    ...
    public k2(InvitedByFragment.BundleInfo bundleInfo) {
    ...
    public int b() {
        return R.id.action_validateNumberWithCallFragment_to_invitedByFragment;
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionValidateNumberWithCallFragmentToInvitedByFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
