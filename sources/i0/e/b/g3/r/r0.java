...
public final class r0 extends ClickableSpan {
    ...
    public r0(CollectPhoneNumberFragment collectPhoneNumberFragment) {
    ...
    public void onClick(View view) {
        ...
        e.b(collectPhoneNumberFragment, collectPhoneNumberFragment.getString(R.string.clubhouse_terms_of_service));
    }
}
