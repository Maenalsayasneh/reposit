...
public final class f2 implements l {
    ...
    public f2(CollectNameArgs collectNameArgs) {
    ...
    public int b() {
        return R.id.action_validateNumberFragment_to_collectNameFragment;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof f2) && i.a(this.a, ((f2) obj).a);
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionValidateNumberFragmentToCollectNameFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
