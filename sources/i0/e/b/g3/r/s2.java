...
/* compiled from: WaitlistFragmentDirections.kt */
public final class s2 implements l {
    public final InvitedByFragment.BundleInfo a;

    public s2(InvitedByFragment.BundleInfo bundleInfo) {
    ...
    public int b() {
        return R.id.action_waitlistFragment_to_invitedByFragment;
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionWaitlistFragmentToInvitedByFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
