...
public final class w implements l {
    ...
    public w(GrowClubArgs growClubArgs) {
    ...
    public int b() {
        return R.id.action_activityFragment_to_clubNominationsFragment;
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionActivityFragmentToClubNominationsFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(')');
        return P0.toString();
    }
