...
public final /* synthetic */ class p implements View.OnClickListener {
    ...
    public /* synthetic */ p(a aVar, ClubWithAdmin clubWithAdmin, ClubFragment clubFragment, d dVar) {
        this.c = aVar;
    ...
    public final void onClick(View view) {
        ...
        if ((aVar instanceof a.c) && !((a.c) aVar).c) {
            clubFragment.T0().p(t1.a);
        }
        if (aVar instanceof a.d) {
            clubFragment.T0().p(new p2(clubWithAdmin.x, true));
        }
