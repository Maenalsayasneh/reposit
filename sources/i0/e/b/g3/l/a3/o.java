...
/* compiled from: ClubNominationsFragmentDirections.kt */
public final class o implements l {
    public final ProfileArgs a;
    public final String b;

    public o(ProfileArgs profileArgs, String str) {
    ...
    public int b() {
        return R.id.action_clubNominationsFragment_to_profileFragment;
    }
    ...
    public String toString() {
        StringBuilder P0 = a.P0("ActionClubNominationsFragmentToProfileFragment(mavericksArg=");
        P0.append(this.a);
        P0.append(", username=");
